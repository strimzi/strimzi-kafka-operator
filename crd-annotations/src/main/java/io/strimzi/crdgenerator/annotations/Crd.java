...
public @interface Crd {
    ...
    @interface Spec {
        ...
        @interface Subresources {
             ...
             * @see <a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#customresourcesubresourcescale-v1-apiextensions-k8s-io">Kubernetes 1.32 API documetation</a>
             */
            @interface Scale {
                /**
