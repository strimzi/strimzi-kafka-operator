...
public class KafkaBridgeCluster extends AbstractModel implements SupportsLogging {
    ...
    protected List<Volume> getVolumes(boolean isOpenShift) {
        ...
        AuthenticationUtils.configurePKCSClientAuthenticationVolumes(authentication, volumeList, "oauth-certs", isOpenShift, "", true);
    ...
    protected List<VolumeMount> getVolumeMounts() {
        ...
        AuthenticationUtils.configurePKCSClientAuthenticationVolumeMounts(authentication, volumeMountList, TLS_CERTS_BASE_VOLUME_MOUNT, PASSWORD_VOLUME_MOUNT, OAUTH_TLS_CERTS_BASE_VOLUME_MOUNT, "oauth-certs", "", true, OAUTH_SECRETS_BASE_VOLUME_MOUNT);
