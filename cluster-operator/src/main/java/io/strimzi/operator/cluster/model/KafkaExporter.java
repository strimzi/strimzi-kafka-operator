...
public class KafkaExporter extends AbstractModel {
    ...
    protected List<Container> getContainers(ImagePullPolicy imagePullPolicy) {
        ...
        Container container = new ContainerBuilder()
                ...
                .withLivenessProbe(httpProbe(livenessPath, METRICS_PORT_NAME, livenessProbeOptions))
                .withReadinessProbe(httpProbe(readinessPath, METRICS_PORT_NAME, readinessProbeOptions))
