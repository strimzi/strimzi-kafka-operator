...
public class KafkaClusterCreator {
    ...
    private Future<KafkaCluster> createKafkaCluster(
        ...
        return Future.succeededFuture(createKafkaCluster(reconciliation, kafkaCr, nodePoolCrs, oldStorage, currentPods, versionChange, kafkaMetadataStateManager, versions, sharedEnvironmentProvider));
    }
