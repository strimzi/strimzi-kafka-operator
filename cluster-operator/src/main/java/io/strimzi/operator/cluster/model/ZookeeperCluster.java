...
public class ZookeeperCluster extends AbstractModel {
    ...
    protected List<Container> getContainers(ImagePullPolicy imagePullPolicy) {
        ...
        Container container = new ContainerBuilder()
                ...
                .withLivenessProbe(execProbe(Collections.singletonList(livenessPath), livenessProbeOptions))
                .withReadinessProbe(execProbe(Collections.singletonList(readinessPath), readinessProbeOptions))
