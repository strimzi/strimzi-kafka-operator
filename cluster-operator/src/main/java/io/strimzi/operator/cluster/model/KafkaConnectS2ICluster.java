    ...
    public DeploymentConfig generateDeploymentConfig(Map<String, String> annotations, boolean isOpenShift) {
        ...
        DeploymentConfig dc = new DeploymentConfigBuilder()
                .withNewMetadata()
                    ...
                    .withAnnotations(mergeAnnotations(null, getDeploymentTemplate().getMetadata().getAnnotations()))
                ...
                .withNewSpec()
                    ...
                    .withNewTemplate()
                        .withNewMetadata()
                            .withAnnotations(mergeAnnotations(annotations, getPodTemplate().getMetadata().getAnnotations()))
