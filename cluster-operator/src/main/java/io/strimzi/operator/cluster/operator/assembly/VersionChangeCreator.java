 ...
 * on the pods.
 */
public class VersionChangeCreator {
    ...
    /**
     * Constructs the VersionChangeCreator which constructs the KafkaVersionChange instance which is describing the
     * upgrade state.
     *
