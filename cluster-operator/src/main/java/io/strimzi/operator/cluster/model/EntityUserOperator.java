...
public class EntityUserOperator extends AbstractModel {
    ...
    public static final String ENV_VAR_CA_CERT_SECRET_NAME = "STRIMZI_CA_CERT_NAME";
    public static final String ENV_VAR_CA_KEY_SECRET_NAME = "STRIMZI_CA_KEY_NAME";
    ...
    protected List<EnvVar> getEnvVars() {
        ...
        varList.add(buildEnvVar(ENV_VAR_CA_KEY_SECRET_NAME, KafkaCluster.clientsCASecretName(cluster)));
        varList.add(buildEnvVar(ENV_VAR_CA_CERT_SECRET_NAME, KafkaCluster.clientsPublicKeyName(cluster)));
        return varList;
    }
