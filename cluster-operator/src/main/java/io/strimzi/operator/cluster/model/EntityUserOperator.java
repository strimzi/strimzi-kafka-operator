...
public class EntityUserOperator extends AbstractModel {
    ...
    protected List<Container> getContainers(ImagePullPolicy imagePullPolicy) {
        ...
        return singletonList(new ContainerBuilder()
                ...
                .withLivenessProbe(ProbeGenerator.of(livenessProbeOptions)
                        .httpProbe(livenessPath + "healthy", HEALTHCHECK_PORT_NAME))
                .withReadinessProbe(ProbeGenerator.of(readinessProbeOptions)
                        .httpProbe(readinessPath + "ready", HEALTHCHECK_PORT_NAME))
