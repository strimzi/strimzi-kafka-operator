...
public class KafkaMirrorMaker2Cluster extends KafkaConnectCluster {
    ...
    protected List<Volume> getVolumes(boolean isOpenShift) {
        ...
        for (KafkaMirrorMaker2ClusterSpec mirrorMaker2Cluster: clusters) {
            ...
            AuthenticationUtils.configurePKCSClientAuthenticationVolumes(mirrorMaker2Cluster.getAuthentication(), volumeList, mirrorMaker2Cluster.getAlias() + "-oauth-certs", isOpenShift, mirrorMaker2Cluster.getAlias() + '-',  true);
        }
        return volumeList;
    }
    ...
    protected List<VolumeMount> getVolumeMounts() {
        ...
        for (KafkaMirrorMaker2ClusterSpec mirrorMaker2Cluster: clusters) {
            ...
            AuthenticationUtils.configurePKCSClientAuthenticationVolumeMounts(mirrorMaker2Cluster.getAuthentication(), volumeMountList, tlsVolumeMountPath, passwordVolumeMountPath, oauthTlsVolumeMountPath, mirrorMaker2Cluster.getAlias() + "-oauth-certs", mirrorMaker2Cluster.getAlias() + '-', true, oauthVolumeMountPath);
        }
