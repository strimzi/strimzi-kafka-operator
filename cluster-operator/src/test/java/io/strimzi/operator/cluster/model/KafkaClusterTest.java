...
public class KafkaClusterTest {
    ...
    private void checkStatefulSet(StatefulSet sts, Kafka cm, boolean isOpenShift) {
        ...
        assertThat(AbstractModel.containerEnvVars(tlsSidecarContainer).get(KafkaCluster.ENV_VAR_KAFKA_ZOOKEEPER_CONNECT), is(ZookeeperCluster.serviceName(cluster) + ":2281"));
