...
public class KafkaBrokerConfigurationDiffTest {
    ...
    public void testDefaultValue() {
        KafkaBrokerConfigurationDiff kcd = new KafkaBrokerConfigurationDiff(new Reconciliation("test", "kind", "namespace", "name"), getCurrentConfiguration(emptyList()), getDesiredConfiguration(emptyList()), kafkaVersion, brokerId);
    ...
    public void testNonDefaultValue() {
        ...
        KafkaBrokerConfigurationDiff kcd = new KafkaBrokerConfigurationDiff(new Reconciliation("test", "kind", "namespace", "name"), getCurrentConfiguration(ces),
    ...
    public void testCustomPropertyAdded() {
        ...
        KafkaBrokerConfigurationDiff kcd = new KafkaBrokerConfigurationDiff(new Reconciliation("test", "kind", "namespace", "name"), getCurrentConfiguration(new ArrayList<>()), getDesiredConfiguration(ces), kafkaVersion, brokerId);
    ...
    public void testChangedPresentValue() {
        ...
        KafkaBrokerConfigurationDiff kcd = new KafkaBrokerConfigurationDiff(new Reconciliation("test", "kind", "namespace", "name"), getCurrentConfiguration(emptyList()),
                getDesiredConfiguration(ces), kafkaVersion, brokerId);
