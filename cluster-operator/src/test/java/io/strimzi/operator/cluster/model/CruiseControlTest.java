...
import io.strimzi.operator.cluster.model.cruisecontrol.DiskCapacity;
...
public class CruiseControlTest {
    ...
    public void testBrokerCapacity() {
        ...
        for (Object brokerEntry : brokerEntries) {
            ...
            Object diskCapacity = brokerCapacity.getValue(DiskCapacity.KEY);
            JsonObject cpuCapacity  = brokerCapacity.getJsonObject(CpuCapacity.KEY);
    ...
    public void testBrokerCapacityOverrides() {
        ...
        assertThat(brokerEntry2.getString(InboundNetworkCapacity.KEY), is(NetworkCapacity.getThroughputInKiB(inboundNetworkOverride0)));
    }
    ...
    public void testBrokerCapacitiesWithPools() {
        ...
        JsonObject brokerCpuCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CpuCapacity.KEY);
        assertThat(brokerCpuCapacity.getString("num.cores"), is("4.0"));
        JsonObject brokerDiskCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(DiskCapacity.KEY);
        ...
        brokerCpuCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CpuCapacity.KEY);
        assertThat(brokerCpuCapacity.getString("num.cores"), is("4.0"));
        brokerDiskCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(DiskCapacity.KEY);
    ...
    private void verifyBrokerCapacity(Map<String, Storage> storage,
        ...
        assertThat(brokerEntries.getJsonObject(0).getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CpuCapacity.KEY).getString("num.cores"), is(Matchers.equalTo(brokerOneCpuValue)));
        assertThat(brokerEntries.getJsonObject(1).getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CpuCapacity.KEY).getString("num.cores"), is(Matchers.equalTo(brokerTwoCpuValue)));
        assertThat(brokerEntries.getJsonObject(2).getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CpuCapacity.KEY).getString("num.cores"), is(Matchers.equalTo(brokerThreeCpuValue)));
    }
