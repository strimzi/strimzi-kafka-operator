...
import static io.strimzi.operator.cluster.model.cruisecontrol.ResourceCapacityType.DISK;
...
public class CruiseControlTest {
    ...
    public void testBrokerCapacity() {
        ...
        JsonArray brokerEntries = capacity.getJsonArray(CapacityConfiguration.CAPACITIES_KEY);

        for (Object brokerEntry : brokerEntries) {
            JsonObject brokerCapacity = ((JsonObject) brokerEntry).getJsonObject(CapacityConfiguration.CAPACITY_KEY);
    ...
    public void testBrokerCapacityOverrides() {
        ...
        assertThat(brokerEntry0.getString(INBOUND_NETWORK.getKey()), is(NetworkCapacity.getThroughputInKiB(inboundNetworkOverride0)));
        assertThat(brokerEntry0.getString(OUTBOUND_NETWORK.getKey()), is(NetworkCapacity.getThroughputInKiB(OUTBOUND_NETWORK.getDefaultResourceCapacity())));
        ...
        assertThat(brokerEntry1.getString(INBOUND_NETWORK.getKey()), is(NetworkCapacity.getThroughputInKiB(inboundNetworkOverride0)));
        assertThat(brokerEntry1.getString(OUTBOUND_NETWORK.getKey()), is(NetworkCapacity.getThroughputInKiB(OUTBOUND_NETWORK.getDefaultResourceCapacity())));
        ...
        assertThat(brokerEntry2.getString(INBOUND_NETWORK.getKey()), is(NetworkCapacity.getThroughputInKiB(inboundNetworkOverride0)));
    }
    ...
    public void testBrokerCapacitiesWithPools() {
        ...
        JsonObject brokerCpuCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CPU.getKey());
        assertThat(brokerCpuCapacity.getString("num.cores"), is("4.0"));
        JsonObject brokerDiskCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(DISK.getKey());
        ...
        brokerCpuCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CPU.getKey());
        assertThat(brokerCpuCapacity.getString("num.cores"), is("4.0"));
        brokerDiskCapacity = brokerEntry.getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(DISK.getKey());
    ...
    private void verifyBrokerCapacity(Map<String, Storage> storage,
        ...
        assertThat(brokerEntries.getJsonObject(0).getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CPU.getKey()).getString("num.cores"), is(Matchers.equalTo(brokerOneCpuValue)));
        assertThat(brokerEntries.getJsonObject(1).getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CPU.getKey()).getString("num.cores"), is(Matchers.equalTo(brokerTwoCpuValue)));
        assertThat(brokerEntries.getJsonObject(2).getJsonObject(CapacityConfiguration.CAPACITY_KEY).getJsonObject(CPU.getKey()).getString("num.cores"), is(Matchers.equalTo(brokerThreeCpuValue)));
    }
