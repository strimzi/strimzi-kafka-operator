...
public class KafkaConnectS2IClusterTest {
    ...
    public void testGenerateService()   {
        ...
        assertThat(svc.getSpec().getPorts().get(1).getName(), is(AbstractModel.PROMETHEUS_METRICS_PORT_NAME));
        assertThat(svc.getSpec().getPorts().get(1).getPort(), is(new Integer(KafkaCluster.PROMETHEUS_METRICS_PORT)));
