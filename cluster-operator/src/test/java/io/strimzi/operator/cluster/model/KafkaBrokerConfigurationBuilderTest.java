...
public class KafkaBrokerConfigurationBuilderTest {
    ...
    public void testKraftControllerAndBrokerNodes()  {
        ...
        // Broker-only node
        configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "11")
                .withKRaft("my-cluster", "my-namespace", Set.of(ProcessRoles.BROKER), nodes)
                .build();

        assertThat(configuration, isEquivalent("broker.id=11",
                "node.id=11",
    ...
    public void testWithNoListeners() {
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withListeners("my-cluster", "my-namespace", NODE_REF, emptyList(), null, null, false)
                .build();
    ...
    public void testConnectionLimits()  {
        ...
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withListeners("my-cluster", "my-namespace", NODE_REF, asList(listener1, listener2, listener3, listener4), listenerId -> "dummy-advertised-address", listenerId -> "1919", false)
                .build();
    ...
    public void testWithPlainListenersWithoutAuth()  {
        ...
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withListeners("my-cluster", "my-namespace", NODE_REF, singletonList(listener), listenerId -> "my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc", listenerId -> "9092", false)
                .build();
    ...
    public void testKraftListenersMixedNodes()  {
        ...
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withKRaft("my-cluster", "my-namespace", Set.of(ProcessRoles.BROKER, ProcessRoles.CONTROLLER), nodes)
                .withListeners("my-cluster", "my-namespace", new NodeRef("my-cluster-kafka-2", 2, "kafka", true, true), singletonList(listener), listenerId -> "my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc", listenerId -> "9092", true)
                .build();
    ...
    public void testKraftListenersBrokerAndControllerNodes()  {
        ...
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withKRaft("my-cluster", "my-namespace", Set.of(ProcessRoles.CONTROLLER), nodes)
                .withListeners("my-cluster", "my-namespace", new NodeRef("my-cluster-controllers-2", 2, "controllers", true, false), singletonList(listener), listenerId -> "my-cluster-controllers-2.my-cluster-kafka-brokers.my-namespace.svc", listenerId -> "9092", true)
                .build();
        ...
        configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "11")
                .withKRaft("my-cluster", "my-namespace", Set.of(ProcessRoles.BROKER), nodes)
                .withListeners("my-cluster", "my-namespace", new NodeRef("my-cluster-brokers-11", 11, "brokers", false, true), singletonList(listener), listenerId -> "my-cluster-brokers-11.my-cluster-kafka-brokers.my-namespace.svc", listenerId -> "9092", true)
                .build();
    ...
    public void testPerBrokerWithExternalListeners()  {
        ...
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withListeners("my-cluster", "my-namespace", NODE_REF, singletonList(listener), listenerId -> "my-lb.com", listenerId -> "9094", false)
                .build();
    ...
    public void testPerBrokerWithExternalListenersNodePortWithoutTls()  {
        ...
        String configuration = new KafkaBrokerConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, "2")
                .withListeners("my-cluster", "my-namespace", NODE_REF, singletonList(listener), listenerId -> "${STRIMZI_NODEPORT_DEFAULT_ADDRESS}", listenerId -> "31234", false)
                .build();
    ...
    public void testOAuthOptions()  {
        ...
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_CLIENT_ID, "my-kafka-id");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_VALID_ISSUER_URI, "http://valid-issuer");
        ...
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_CUSTOM_CLAIM_CHECK, "@.aud && @.aud == 'something'");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_SCOPE, "messaging");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_AUDIENCE, "kafka");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_JWKS_ENDPOINT_URI, "http://jwks-endpoint");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_JWKS_REFRESH_SECONDS, "50");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_JWKS_EXPIRY_SECONDS, "160");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_JWKS_REFRESH_MIN_PAUSE_SECONDS, "5");
        KafkaBrokerConfigurationBuilder.addBooleanOptionIfTrue(expectedOptions, ServerConfig.OAUTH_JWKS_IGNORE_KEY_USE, true);
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_INTROSPECTION_ENDPOINT_URI, "http://introspection-endpoint");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_USERINFO_ENDPOINT_URI, "http://userinfo-endpoint");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_USERNAME_CLAIM, "preferred_username");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_FALLBACK_USERNAME_CLAIM, "client_id");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_FALLBACK_USERNAME_PREFIX, "client-account-");
        ...
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_VALID_TOKEN_TYPE, "access_token");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM, "");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_CONNECT_TIMEOUT_SECONDS, "30");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_READ_TIMEOUT_SECONDS, "60");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_HTTP_RETRIES, "2");
        KafkaBrokerConfigurationBuilder.addOptionIfNotNull(expectedOptions, ServerConfig.OAUTH_HTTP_RETRY_PAUSE_MILLIS, "500");
