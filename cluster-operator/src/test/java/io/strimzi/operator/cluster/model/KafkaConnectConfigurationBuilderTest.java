...
class KafkaConnectConfigurationBuilderTest {
    ...
    public void testWithTls() {
        ...
        String configuration = new KafkaConnectConfigurationBuilder(Reconciliation.DUMMY_RECONCILIATION, BOOTSTRAP_SERVERS)
                .withTls(clientTls, "tls-trusted-certificate-secret")
                .build();
        ...
        assertThat(configuration, isEquivalent(
                ...
                "ssl.truststore.certificates=${strimzisecrets:namespace/tls-trusted-certificate-secret:*.crt}",
                "ssl.truststore.type=PEM",
                "producer.ssl.truststore.certificates=${strimzisecrets:namespace/tls-trusted-certificate-secret:*.crt}",
                "producer.ssl.truststore.type=PEM",
                "consumer.ssl.truststore.certificates=${strimzisecrets:namespace/tls-trusted-certificate-secret:*.crt}",
                "consumer.ssl.truststore.type=PEM",
                "admin.ssl.truststore.certificates=${strimzisecrets:namespace/tls-trusted-certificate-secret:*.crt}",
