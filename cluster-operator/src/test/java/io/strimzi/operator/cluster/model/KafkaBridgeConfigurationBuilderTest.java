...
public class KafkaBridgeConfigurationBuilderTest {
    ...
    public void testHttp() {
        ...
        assertThat(configuration, isEquivalent(
                ...
                "http.ssl.certificate.location=/opt/strimzi/bridge-server-certs/my-secret/cert.crt",
                "http.ssl.key.location=/opt/strimzi/bridge-server-certs/my-secret/private.key",
