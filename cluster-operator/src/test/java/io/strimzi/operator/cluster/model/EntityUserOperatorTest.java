...
public class EntityUserOperatorTest {
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityUserOperator.ENV_VAR_CLIENTS_CA_VALIDITY).withValue(Integer.toString(AbstractModel.CERTS_VALIDITY_DAYS)).build());
        expected.add(new EnvVarBuilder().withName(EntityUserOperator.ENV_VAR_CLIENTS_CA_RENEWAL).withValue(Integer.toString(AbstractModel.CERTS_RENEWAL_DAYS)).build());
        return expected;
    }
    ...
    public void testFromCrdCaValidityAndRenewal() {
        ...
        assertEquals(AbstractModel.CERTS_VALIDITY_DAYS, entityUserOperator2.getClientsCaValidityDays());
        assertEquals(AbstractModel.CERTS_RENEWAL_DAYS, entityUserOperator2.getClientsCaRenewalDays());
    }
}
