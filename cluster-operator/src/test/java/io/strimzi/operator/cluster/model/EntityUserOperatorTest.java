...
public class EntityUserOperatorTest {
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityUserOperator.ENV_VAR_CA_KEY_SECRET_NAME).withValue(KafkaCluster.clientsCASecretName(cluster)).build());
        expected.add(new EnvVarBuilder().withName(EntityUserOperator.ENV_VAR_CA_CERT_SECRET_NAME).withValue(KafkaCluster.clientsPublicKeyName(cluster)).build());
        return expected;
    }
