...
import io.strimzi.api.kafka.model.tls.TlsSidecar;
...
public class ProbeUtilsTest {
    ...
    private static final io.strimzi.api.kafka.model.common.Probe DEFAULT_CONFIG = new io.strimzi.api.kafka.model.ProbeBuilder()
    ...
    public void testZeroInitialDelayIsSetToNull() {
        io.strimzi.api.kafka.model.common.Probe probeConfig = new io.strimzi.api.kafka.model.ProbeBuilder()
