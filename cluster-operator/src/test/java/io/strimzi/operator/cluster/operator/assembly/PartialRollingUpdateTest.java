...
public class PartialRollingUpdateTest {
    ...
    public void before(TestContext context) {
        ...
        KafkaAssemblyOperator kco = new KafkaAssemblyOperator(vertx, new PlatformFeaturesAvailability(true, KubernetesVersion.V1_9), ResourceUtils.dummyClusterOperatorConfig(VERSIONS, 2_000),
    ...
    private void startKube() {
        ...
        this.kco = new KafkaAssemblyOperator(vertx, new PlatformFeaturesAvailability(true, KubernetesVersion.V1_9), ResourceUtils.dummyClusterOperatorConfig(VERSIONS, 2_000),
                new MockCertManager(), supplier);
