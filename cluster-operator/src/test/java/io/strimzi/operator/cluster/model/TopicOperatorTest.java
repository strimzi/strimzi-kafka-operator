...
public class TopicOperatorTest {
    ...
    public void testGenerateDeployment() {
        ...
        assertEquals(TopicOperator.TLS_SIDECAR1_VOLUME_NAME, containers.get(0).getVolumeMounts().get(1).getName());
        assertEquals(TopicOperator.TLS_SIDECAR1_VOLUME_MOUNT, containers.get(0).getVolumeMounts().get(1).getMountPath());
        ...
        assertEquals(TopicOperator.TLS_SIDECAR1_VOLUME_NAME, containers.get(1).getVolumeMounts().get(0).getName());
        assertEquals(TopicOperator.TLS_SIDECAR1_VOLUME_MOUNT, containers.get(1).getVolumeMounts().get(0).getMountPath());
    }
