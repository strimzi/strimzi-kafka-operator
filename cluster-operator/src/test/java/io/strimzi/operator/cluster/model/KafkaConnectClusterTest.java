                ...
                .editSpec()
                    ...
                    .withNewTemplate()
                        ...
                        .withNewPod()
                            ...
                            .withAdditionalVolumes(additionalVolumeSecret, additionalVolumeEmptyDir, additionalVolumeConfigMap)
                        .endPod()
                        .withNewConnectContainer()
                            .withAdditionalVolumeMounts(additionalVolumeMountSecret, additionalVolumeMountEmptyDir)
                        .endConnectContainer()
