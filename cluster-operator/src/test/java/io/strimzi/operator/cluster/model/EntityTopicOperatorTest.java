...
public class EntityTopicOperatorTest {
    ...
    public void testSetupWithCruiseControlEnabled() {
        ...
        expectedEnvVars.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_TRUSTSTORE_SECRET_NAME).withValue("my-cluster-cluster-ca-cert").build());
        expectedEnvVars.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_KEYSTORE_SECRET_NAME).withValue("my-cluster-entity-topic-operator-certs").build());
        expectedEnvVars.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_KEYSTORE_KEY_NAME).withValue("entity-operator.key").build());
        expectedEnvVars.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_KEYSTORE_CERTIFICATE_NAME).withValue("entity-operator.crt").build());
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_TRUSTSTORE_SECRET_NAME).withValue("my-cluster-cluster-ca-cert").build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_KEYSTORE_SECRET_NAME).withValue("my-cluster-entity-topic-operator-certs").build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_KEYSTORE_KEY_NAME).withValue("entity-operator.key").build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_TLS_KEYSTORE_CERTIFICATE_NAME).withValue("entity-operator.crt").build());
