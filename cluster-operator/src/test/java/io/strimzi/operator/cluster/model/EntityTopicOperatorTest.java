...
public class EntityTopicOperatorTest {
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_EO_CERTIFICATE_CHAIN_DATA).withValueFrom(new EnvVarSourceBuilder().withSecretKeyRef(new SecretKeySelectorBuilder().withKey("entity-operator.crt").withName("foo-entity-operator-certs").build()).build()).build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_EO_KEY_SECRET_DATA).withValueFrom(new EnvVarSourceBuilder().withSecretKeyRef(new SecretKeySelectorBuilder().withKey("entity-operator.key").withName("foo-entity-operator-certs").build()).build()).build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_CLUSTER_CA_CERT_SECRET_DATA).withValue("").build());
