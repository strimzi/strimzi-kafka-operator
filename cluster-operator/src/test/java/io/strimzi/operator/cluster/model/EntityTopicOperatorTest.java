...
public class EntityTopicOperatorTest {
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_STRIMZI_KAFKA_VERSION).withValue(KafkaVersionTestConstants.LATEST_KAFKA_VERSION).build());
