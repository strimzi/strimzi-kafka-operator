...
public class EntityTopicOperatorTest {
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_CLUSTER_CA_CERT_SECRET_NAME).withValue(KafkaCluster.clusterCaCertSecretName(cluster)).build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_EO_KEY_SECRET_NAME).withValue(EntityOperator.secretName(cluster)).build());
