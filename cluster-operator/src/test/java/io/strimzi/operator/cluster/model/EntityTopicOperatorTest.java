...
public class EntityTopicOperatorTest {
    ...
    private List<EnvVar> getExpectedEnvVars() {
        ...
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_STRIMZI_GC_LOG_TO_FILE).withValue(Boolean.toString(AbstractModel.DEFAULT_JVM_GC_LOG_TO_FILE)).build());
        expected.add(new EnvVarBuilder().withName(EntityTopicOperator.ENV_VAR_STRIMZI_GC_LOG_FILEPATH).withValue(EntityTopicOperator.DEFAULT_GC_LOG_FILEPATH).build());
        return expected;
    }
