...
public class KafkaVersionTestUtils {
    ...
    public static final String LATEST_KAFKA_VERSION = "4.3.0";
    public static final String LATEST_FORMAT_VERSION = "4.3";
    public static final String LATEST_PROTOCOL_VERSION = "4.3";
    public static final String LATEST_METADATA_VERSION = "4.3-IV0";
    public static final String LATEST_CHECKSUM = "ABCD1234";
    public static final String LATEST_THIRD_PARTY_VERSION = "4.3.x";
    ...
    public static final String PREVIOUS_KAFKA_VERSION = "4.2.0";
    public static final String PREVIOUS_FORMAT_VERSION = "4.2";
    public static final String PREVIOUS_PROTOCOL_VERSION = "4.2";
    public static final String PREVIOUS_METADATA_VERSION = "4.2-IV1";
    public static final String PREVIOUS_CHECKSUM = "ABCD1234";
    public static final String PREVIOUS_THIRD_PARTY_VERSION = "4.2.x";
