...
public class KafkaVersionTestUtils {
    ...
    public static final String LATEST_KAFKA_VERSION = "3.1.0";
    public static final String LATEST_FORMAT_VERSION = "3.1";
    public static final String LATEST_PROTOCOL_VERSION = "3.1";
    public static final String LATEST_ZOOKEEPER_VERSION = "3.6.3";
    public static final String LATEST_CHECKSUM = "ABCD1234";
    public static final String LATEST_THIRD_PARTY_VERSION = "3.1.x";
    ...
    public static final String PREVIOUS_KAFKA_VERSION = "3.0.0";
    public static final String PREVIOUS_FORMAT_VERSION = "3.0";
    public static final String PREVIOUS_PROTOCOL_VERSION = "3.0";
    public static final String PREVIOUS_ZOOKEEPER_VERSION = "3.6.3";
    public static final String PREVIOUS_CHECKSUM = "ABCD1234";
    public static final String PREVIOUS_THIRD_PARTY_VERSION = "3.0.x";
