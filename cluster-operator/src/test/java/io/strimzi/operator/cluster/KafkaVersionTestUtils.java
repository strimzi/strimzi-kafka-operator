...
public class KafkaVersionTestUtils {
    ...
    public static final String LATEST_MINOR_KAFKA_VERSION = "2.7.0";
    public static final String LATEST_MINOR_FORMAT_VERSION = "2.7";
    public static final String LATEST_MINOR_PROTOCOL_VERSION = "2.7";
    public static final String LATEST_MINOR_ZOOKEEPER_VERSION = "3.5.8";
    public static final String LATEST_MINOR_CHECKSUM = "ABCD1234";
    public static final String LATEST_MINOR_THIRD_PARTY_VERSION = "2.7.x";
    ...
    public static final String PREVIOUS_MINOR_KAFKA_VERSION = "2.6.0";
    public static final String PREVIOUS_MINOR_FORMAT_VERSION = "2.6";
    public static final String PREVIOUS_MINOR_PROTOCOL_VERSION = "2.6";
    public static final String PREVIOUS_MINOR_ZOOKEEPER_VERSION = "3.5.8";
    public static final String PREVIOUS_MINOR_CHECKSUM = "ABCD1234";
    public static final String PREVIOUS_MINOR_THIRD_PARTY_VERSION = "2.6.x";
