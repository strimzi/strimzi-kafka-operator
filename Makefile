...
docu_versions:
	documentation/snip-kafka-versions.sh kafka-versions.yaml > documentation/book/snip-kafka-versions.adoc
	documentation/version-dependent-attrs.sh kafka-versions.yaml > documentation/book/common/version-dependent-attrs.adoc
	documentation/snip-images.sh kafka-versions.yaml > documentation/book/snip-images.adoc
