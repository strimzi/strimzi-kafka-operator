...
listener.name.client.ssl.keystore.location=/tmp/kafka/clients.keystore.jks
listener.name.client.ssl.truststore.location=/tmp/kafka/clients.truststore.jks
