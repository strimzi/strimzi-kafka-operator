...
envsubst \
    '${STRIMZI_BROKER_ID},${STRIMZI_RACK_ID},${CERTS_STORE_PASSWORD},${STRIMZI_CLIENT_9092_OAUTH_CLIENT_SECRET},${STRIMZI_TLS_9093_OAUTH_CLIENT_SECRET},${STRIMZI_EXTERNAL_9094_OAUTH_CLIENT_SECRET},${STRIMZI_EXTERNAL_9094_ADVERTISED_HOSTNAME},${STRIMZI_EXTERNAL_9094_ADVERTISED_PORT}' \
