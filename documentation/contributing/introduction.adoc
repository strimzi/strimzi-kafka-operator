...
https://github.com/strimzi/strimzi-kafka-bridge[`strimzi-kafka-bridge`^] (GitHub):: HTTP Bridge code and related documentation.
...
The HTTP Bridge documentation shows how to get started using the HTTP Bridge to make HTTP requests to a Kafka cluster.

The HTTP Bridge documentation is maintained in the https://github.com/strimzi/strimzi-kafka-bridge[HTTP Bridge project in GitHub].
For information on contributing to the HTTP Bridge documentation, see the https://github.com/strimzi/strimzi-kafka-bridge/blob/main/README.md[`readme`]  in the HTTP Bridge project.
