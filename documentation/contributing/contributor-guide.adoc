...
This procedure shows the steps to contribute to the Strimzi documentation.
...
Strimzi aims to make its web content accessible.
When contributing to the documentation, ensure that your content adheres to the following:
