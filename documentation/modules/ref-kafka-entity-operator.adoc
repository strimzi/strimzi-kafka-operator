...
For more information on the properties to configure the Entity Operator, see the link:type-EntityUserOperatorSpec-reference[`EntityUserOperatorSpec` schema reference^].
