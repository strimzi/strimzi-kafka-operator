...
If a feature gate is not enabled, you may need to enable it before upgrading. 
If the feature gate is unavailable in your current version, you may need to upgrade to a version that allows you to enable it first.
