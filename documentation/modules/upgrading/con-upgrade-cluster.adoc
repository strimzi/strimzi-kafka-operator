...
. Backup your Kubernetes components
...
If you used the Operator Lifecycle Manager (OLM) to install the Strimzi Operator using the _stable_ channel, Strimzi updates are discovered automatically after the Kubernetes upgrade.
If you have specified automatic OLM updates, the Strimzi Operator will automatically upgrade to the version of Strimzi that was released for the upgraded Kubernetes cluster version.
