...
NOTE: In the context of Kafka Connect, a _partition_ can mean a topic partition or a _shard of data_ intended for an external system.

== Workers

Workers employ the initial connector configuration deployed to the Kafka Connect cluster.
