...
[role="_abstract"]
Kafka MirrorMaker replicates data between two or more active Kafka clusters, within or across data centers.
...
NOTE: MirrorMaker was deprecated for Kafka 3.0.0 and will be removed in Kafka 4.0.0.
