...
+
When you define the specification for your Kafka cluster using the `Kafka` resource, you can set resource usage limits for the Topic Operator and User Operator. 
