...
== HTTP requests
The HTTP Bridge supports HTTP requests to a Kafka cluster, with methods to perform operations such as the following:
...
* To view the API documentation, including example requests and responses, see link:{BookURLBridge}[Using the HTTP Bridge^].
