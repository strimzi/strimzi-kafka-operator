...
* link:https://csrc.nist.gov/Projects/cryptographic-module-validation-program/validated-modules[National Institute of Standards and Technology (NIST): Cryptographic Module Validation Program^]