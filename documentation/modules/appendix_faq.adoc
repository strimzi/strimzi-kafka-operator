...
* xref:co-faq-standard-users_{context}[Why can't standard Kubernetes users create Kafka custom resources?]
...
=== Why can't standard Kubernetes users create Kafka custom resources?
