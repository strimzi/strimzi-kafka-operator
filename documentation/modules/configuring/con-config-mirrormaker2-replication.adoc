...
TIP: You can use Kafka's `RemoteClusterUtils.java` utility in your client application to retrieve the remote offsets for a consumer group from the `checkpoints` topic.
