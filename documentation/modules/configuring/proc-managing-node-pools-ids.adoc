...
* `strimzi.io/next-node-ids` to add a range of IDs for scaling up
* `strimzi.io/remove-node-ids` to add a range of IDs for scaling down
...
Conversely, when scaling down, you can specify a range like [`1999-1000`], ensuring that nodes with the next highest IDs are removed: `1999`, `1998`, `1997`, `1996`, and so on.
