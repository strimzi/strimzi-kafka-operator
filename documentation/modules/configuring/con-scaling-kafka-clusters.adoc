...
If you are managing nodes in the cluster using the node pools feature, you adjust the `KafkaNodePool.spec.replicas` configuration to change the number of nodes in the node pool.
