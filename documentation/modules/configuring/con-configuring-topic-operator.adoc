...
NOTE: If you are using the preview of unidirectional topic management, the following properties are not used and will be ignored: `zookeeperSessionTimeoutSeconds` and `topicMetadataMaxAttempts`.
