...
* A `ClusterRole` that grants permissions to Prometheus to read the health endpoints exposed by the Kafka pods, cAdvisor and the kubelet for container metrics.
