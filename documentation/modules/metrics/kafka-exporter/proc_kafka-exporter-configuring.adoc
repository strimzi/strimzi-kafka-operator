...
For more information about configuring the `Kafka` resource, see the link:{BookURLUsing}#ref-sample-kafka-resource-config-deployment-configuration-kafka[sample Kafka YAML configuration] in the _Using Strimzi_ guide.
