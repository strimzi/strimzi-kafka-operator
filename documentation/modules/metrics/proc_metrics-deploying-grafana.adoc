...
you can use your own Grafana installation or deploy Grafana by applying the `grafana.yaml` file provided in the link:https://github.com/strimzi/strimzi-kafka-operator/tree/{GithubVersion}/examples/metrics[examples/metrics] directory.
