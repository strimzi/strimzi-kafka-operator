...
. <<example-2, Configuring token validation using introspection endpoint>>
...
--
[[example-1]]
.Example 1: Configuring external client access for {oauth} with Kafka broker using secure connection to authorization server
