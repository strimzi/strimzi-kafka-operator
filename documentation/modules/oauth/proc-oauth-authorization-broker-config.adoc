...
* You need to understand how to manage policies and permissions for Keycloak Authorization Services, as described in the xref:con-oauth-authorization-keycloak-authorization-services_str[Manage policies and permissions in Keycloak Authorization Services].
