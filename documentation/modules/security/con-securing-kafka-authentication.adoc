...
The secret contains a public CA certificate.
The public CA certificate is in xref:certificates-and-secrets-formats-{context}[PEM and PKCS #12 format].
To verify a Kafka cluster, you add the public CA certificate to the truststore in your client configuration.
To verify the client, you add user credentials to keystore in your client configuration.
