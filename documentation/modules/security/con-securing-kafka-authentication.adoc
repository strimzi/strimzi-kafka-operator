...
To verify a Kafka cluster, you add the CA certificate to the truststore in your client configuration.
To verify a client, you add a user certificate and key to the keystore in your client configuration.
