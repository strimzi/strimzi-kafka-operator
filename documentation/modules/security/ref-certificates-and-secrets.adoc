...
By configuring the `clusterCaCert` template property, you can add custom labels and annotations to the Cluster CA Secrets created by the Cluster Operator.
