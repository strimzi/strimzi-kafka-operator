...
== Add labels and annotations to Secrets

By configuring the `clusterCaCert` template property, you can add custom labels and annotations to the Secrets created by the Cluster Operator.
