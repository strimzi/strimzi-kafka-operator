...
By configuring the `clusterCaCert` template property, you can add custom labels and annotations to the Secrets for the cluster CA certificate created by the Cluster Operator.
