...
* `cordoned.log.dirs` to cordon brokers during scale-down operations
...
* link:{BookURLConfiguring}#type-KafkaClusterSpec-reference[`KafkaClusterSpec` schema reference for a list of exclusions]
