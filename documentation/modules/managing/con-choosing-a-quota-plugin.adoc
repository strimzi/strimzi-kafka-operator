...
* Apply per-broker and per-user limits (broker-level limits can be overridden by configuring user-specific quotas)
...
* xref:con-configuring-client-quotas-str[Configuring user-specific quotas]