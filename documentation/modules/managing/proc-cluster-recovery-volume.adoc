...
pvc-5e9c5c7f-3317-11ea-a650-06e1eadd9a4c ...  Retain ...     my-project/data-0-my-cluster-broker-0
pvc-5e9cc72d-3317-11ea-97b0-0aef8816c7ea ...  Retain ...     my-project/data-0-my-cluster-broker-1
pvc-5ead43d1-3317-11ea-97b0-0aef8816c7ea ...  Retain ...     my-project/data-0-my-cluster-broker-2
pvc-7e1f67f9-3317-11ea-a650-06e1eadd9a4c ...  Retain ...     my-project/data-0-my-cluster-controller-3
pvc-7e21042e-3317-11ea-9786-02deaf9aa87e ...  Retain ...     my-project/data-0-my-cluster-controller-4
pvc-7e226978-3317-11ea-97b0-0aef8816c7ea ...  Retain ...     my-project/data-0-my-cluster-controller-5
----
+
...
.. Edit the `Kafka` resource using the `--subresource status` flag to set the `clusterId` with the recovered value:
+
[source,shell]
----
status:
