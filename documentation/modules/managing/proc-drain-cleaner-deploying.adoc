...
* If you are using `cert-manager`, apply the resources in the `/install/certmanager` directory.
+
...
* If you are not using `cert-manager`, apply the resources in the `/install/kubernetes` directory.
+
[source,shell,subs="attributes+"]
----
