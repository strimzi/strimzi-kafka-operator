...
= Enabling tracing in Mirror Maker, Kafka Connect, and Kafka Bridge resources
...
* Interceptor classes are updated in the integrated consumers and producers in Mirror Maker, Kafka Connect, or the {ProductName} Kafka Bridge.
