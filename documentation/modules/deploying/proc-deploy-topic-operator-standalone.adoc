...
. If you enabled TLS with the `STRIMZI_TLS_ENABLED` environment variable, specify names of the secrets containing public and private keys used to authenticate connection to the Kafka cluster.
+
