...
This causes the Topic Operator connected to each cluster to compete for the same internal topics, such as `__consumer_offsets`, leading to name collisions and unpredictable behavior.
