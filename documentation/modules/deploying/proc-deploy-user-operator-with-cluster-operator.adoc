...
For more information about configuring the `entityOperator` and `userOperator` properties, see xref:assembly-kafka-entity-operator-str[Configuring the Entity Operator].
