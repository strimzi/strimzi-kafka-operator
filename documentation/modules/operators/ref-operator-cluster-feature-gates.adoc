...
When upgrading to Strimzi 0.46.0 or newer from Strimzi 0.34.0 or older while using the Kafka operand, make sure the `UseStrimziPodSets` feature gate is enabled and `StrimziPodSets` are used before starting the upgrade.
