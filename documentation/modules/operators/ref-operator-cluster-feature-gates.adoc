...
Graduated feature gates have reached General Availability (GA) and are permanently enabled.
...
== Early access feature gates (alpha/beta)

Early access feature gates have not yet reached the GA stage, and they can be enabled or disabled. 
