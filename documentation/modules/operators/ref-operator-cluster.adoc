...
This feature is introduced in Strimzi 0.23 and is expected to remain in the alpha phase for four releases before moving to the beta phase and be enabled by default.
