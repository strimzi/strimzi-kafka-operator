...
Bidirectional mode:: Bidirectional mode requires ZooKeeper for cluster management. It is not compatible with Strimzi in KRaft mode.

(Preview) Unidirectional mode:: Unidirectional mode does not require ZooKeeper for cluster management. It is not compatible with Strimzi in KRaft mode.
