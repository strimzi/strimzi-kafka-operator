...
NOTE: Requirements for identifiers and names in Kubernetes are outlined in link:https://kubernetes.io/docs/concepts/overview/working-with-objects/names[Object Names and IDs^] document.
