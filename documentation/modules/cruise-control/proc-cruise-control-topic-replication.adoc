...
* Basic authorization credentials (user name and password) in `/etc/eto-cc-api/topic-operator.apiAdminUsername` and `/etc/eto-cc-api/topic-operator.apiAdminPassword`
