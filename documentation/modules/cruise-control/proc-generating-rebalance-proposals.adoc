...
[source,shell,subs="+quotes"]
----
kubectl get kafkarebalance <rebalance-cr-name> -o jsonpath='{.status}'
----
+
...
----
+
For information about the different properties, see xref:con-optimization-proposals-{context}[]. 
