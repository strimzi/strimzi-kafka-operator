...
This might be because of excluded topics configuration (`excludedTopics`). 
Optimization proposals ignore excluded topics, but CPU utilization calculations consider their replicas.
