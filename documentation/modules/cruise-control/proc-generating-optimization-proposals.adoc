...
* You have configured xref:con-optimization-goals-{context}[optimization goals] and, optionally, link:#capacity-configuration[capacity limits on broker resources].
