...
Each optimization proposal is based on the set of xref:con-optimization-goals-{context}[optimization goals] that was used to generate it, subject to any configured link#capacity-configuration[capacity limits on broker resources].
