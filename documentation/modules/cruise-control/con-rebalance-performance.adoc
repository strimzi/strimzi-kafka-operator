...
When running a JBOD Kafka deployment, Cruise Control allows balancing partitions between disks on the same broker.
...
| `rebalanceDisk`   .1+|  Whether to balance load between disks within brokers (requires JBOD Kafka deployment)               .1+| false
|============================================================================================================================
