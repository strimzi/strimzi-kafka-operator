...
After plugins have been added to the container image, you can manage the running of connector instances in the following ways:
...
IMPORTANT: You create the configuration for connectors directly using `KafkaConnector` custom resources or the Kafka Connect REST API.
