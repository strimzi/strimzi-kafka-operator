...
include::/modules/proc_deploy-kafka-connect-new-image-from-base.adoc[leveloffset=+1]
//Procedure to create a base images from OpenShift builds and S2I
include::/modules/proc_deploy-kafka-connect-openshift-builds-image.adoc[leveloffset=+1]
