...
//
// deploy/assembly_deploy-tasks.adoc
...
include::modules/proc_deploy-kafka-connect.adoc[leveloffset=+1]
//Options to deploy Kafka Connect with new container image
include::assembly_deploy-kafka-connect-with-plugins.adoc[leveloffset=+1]
//Overview of creating connectors through API
include::modules/con_deploy-kafka-connect-managing-connectors.adoc[leveloffset=+1]
