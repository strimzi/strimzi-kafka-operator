...
[role="_abstract"]
Strimzi simplifies the process of running {ApacheKafkaHome} within a Kubernetes cluster.
...
//info on HTTP Bridge
include::../../modules/deploying/con-http-bridge-concepts.adoc[leveloffset=+1]
//info on FIPS
