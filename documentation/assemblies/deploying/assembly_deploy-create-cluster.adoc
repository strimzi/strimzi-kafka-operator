...
include::assembly_deploy-cluster-operator.adoc[leveloffset=+1]
//Options and instructions for deploying Kafka resource
include::assembly_deploy-kafka-cluster.adoc[leveloffset=+1]
//Alternative standalone deployment of Topic Operator and Cluster Operator
include::assembly_deploy-standalone-operators.adoc[leveloffset=+1]
