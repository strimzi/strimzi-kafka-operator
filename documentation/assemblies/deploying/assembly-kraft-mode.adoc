...
When requests are made to change the cluster configuration, a lead controller manages updates to the metadata log, and follower controllers replicate these updates. 
