...
= Setting up tracing for Mirror Maker, Kafka Connect, and the Kafka Bridge

Distributed tracing is supported for Mirror Maker, Kafka Connect (including Kafka Connect with Source2Image support), and the {ProductName} Kafka Bridge.
...
.Tracing in the the Kafka Bridge
...
In order to have and end-to-end tracing, you must configure tracing in your HTTP clients.
