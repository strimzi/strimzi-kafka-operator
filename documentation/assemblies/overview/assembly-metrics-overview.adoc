...
// UserStory: Describe how metrics data can be collected

[id="metrics-overview_{context}"]
= Metrics

Metrics data allows you to monitor the performance of {ProductName}.
...
include::../../modules/overview/con-metrics-overview-prometheus.adoc[leveloffset=+1]
include::../../modules/overview/con-metrics-overview-grafana.adoc[leveloffset=+1]
include::../../modules/overview/con-metrics-overview-exporter.adoc[leveloffset=+1]
include::../../modules/overview/con-metrics-overview-tracing.adoc[leveloffset=+1]
