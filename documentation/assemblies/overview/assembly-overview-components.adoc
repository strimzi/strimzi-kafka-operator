...
Having discussed the basics of Kafka, we can now look at how {ProductName} supports Kafka using _Operators_ to deploy and manage the components and dependencies of Kafka to Kubernetes.
