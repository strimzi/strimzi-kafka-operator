...
//mention optional upgrade to GenericKafkaListeners here and link to the procedure
//mention upgrade to cooperative rebalance protocol here and link to procedure
