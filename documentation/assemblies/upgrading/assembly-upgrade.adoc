...
If topics are configured for high availability, upgrading should not cause any downtime for consumers and producers that publish and read data from them. 
