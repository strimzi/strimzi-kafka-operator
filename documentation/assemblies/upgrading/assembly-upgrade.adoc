...
The `v1beta2` API version for all custom resources was introduced with Strimzi 0.22.0.
...
. Upgrade to 0.23.0 or newer

NOTE: As an alternative, you can install the custom resources from version 0.22, convert the resources and upgrade to 0.23.0 or newer.
