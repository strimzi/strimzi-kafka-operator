...
If you want to switch from using a ZooKeeper-based Kafka cluster to a KRaft-based cluster as part of your upgrade, see xref:proc-deploy-migrate-kraft-str[].
