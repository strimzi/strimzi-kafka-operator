...
include::modules/con_upgrade-versions-and-images.adoc[leveloffset=+1]

include::modules/con_upgrade-strategies-for-upgrading-clients.adoc[leveloffset=+1]

include::modules/proc_upgrade-brokers-newer-kafka.adoc[leveloffset=+1]

//upgrade clients and kafka streams to incremental cooperative rebalance protocol added in kafka 2.4
include::modules/proc_upgrading-consumers-streams-cooperative-rebalancing.adoc[leveloffset=+1]
