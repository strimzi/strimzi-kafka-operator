...
All labels that are applied to the desired `KafkaConnectS2I` resource will also be applied to the Kubernetes resources making up the Kafka Connect cluster with Source2Image support.
...
include::../modules/deploying/kafkaconnectors/proc-enabling-kafkaconnectors.adoc[leveloffset=+1]
