...
If you want to use certificates issued by an external Certificate Authority (CA), you can install your own certificates for Kafka brokers on a per-listener basis.
