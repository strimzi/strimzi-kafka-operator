...
Communication between Kafka brokers (inter-broker communication), between ZooKeeper nodes (inter-nodal communication), and between those components and the Strimzi operators is always encrypted.
