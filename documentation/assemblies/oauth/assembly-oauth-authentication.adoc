...
[NOTE]
====
OAuth 2.0 authentication can also be used in conjunction with Simple or Open Policy Agent (OPA) based xref:con-securing-kafka-authorization-str[Kafka authorization]. You can also use a custom authorizer.
====
