...
Strimzi supports the use of OAuth 2.0 authentication using the _SASL_OAUTHBEARER_ and _SASL_PLAIN_ mechanisms.
...
[NOTE]
====
OAuth 2.0 authentication can also be used in conjunction with `simple` or Open Policy Agent (OPA) based xref:con-securing-kafka-authorization-str[Kafka authorization].
====
