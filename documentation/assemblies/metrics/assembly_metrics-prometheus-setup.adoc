...
This section describes how to monitor {ProductName} Kafka, ZooKeeper, Kafka Connect, and Kafka MirrorMaker 2.0 clusters using Prometheus to provide monitoring data for example Grafana dashboards.
