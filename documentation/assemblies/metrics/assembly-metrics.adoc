...
Prometheus consumes key metrics from the running pods in your cluster when configured with Prometheus rules. 
...
You can use rules to define conditions that trigger notifications based on specific metrics.

Depending on your monitoringrequirements, you can do the following:
