...
The Strimzi Operator xref:proc-operator-restart-events-{context}[emits Kubernetes events] when it restarts a Kafka broker that can help in understanding cluster behaviour.
...
include::modules/con-metrics-cruise-control.adoc[leveloffset=+1]
