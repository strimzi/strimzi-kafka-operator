...
<13> `KafkaMirrorMaker2` resource for deploying MirrorMaker 2 with Strimzi Metrics Reporter.
<14> `Kafka` resource for deploying Kafka with Strimzi Metrics Reporter.
