...
[role="_abstract"]
You can find example Grafana dashboards and other metrics configuration files in the xref:deploy-examples-{context}[example configuration files] provided by Strimzi.
...
include::modules/ref-prometheus-metrics-config.adoc[leveloffset=+1]
//Example Prometheus alert rules
include::modules/ref_metrics-alertmanager-examples.adoc[leveloffset=+1]
//Example Grafana dashboards
include::modules/ref_metrics-dashboards.adoc[leveloffset=+1]
