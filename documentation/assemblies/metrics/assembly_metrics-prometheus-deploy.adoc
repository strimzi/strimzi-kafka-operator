...
include::modules/con_metrics-prometheus-options.adoc[leveloffset=+1]

include::modules/con_metrics-prometheus-resources.adoc[leveloffset=+1]

include::modules/proc_metrics-deploying-prometheus-operator.adoc[leveloffset=+1]

include::modules/proc_metrics-deploying-prometheus.adoc[leveloffset=+1]
