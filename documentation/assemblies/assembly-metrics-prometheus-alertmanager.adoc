...
include::../modules/con-metrics-alertmanager-options.adoc[leveloffset=+1]

include::../modules/con-metrics-prometheus-alerts.adoc[leveloffset=+1]

include::../modules/ref-metrics-alertmanager-examples.adoc[leveloffset=+1]

include::../modules/proc-metrics-deploying-prometheus-alertmanager.adoc[leveloffset=+1]
