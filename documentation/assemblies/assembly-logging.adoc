...
include::../modules/ref-loggers-{kind}.adoc[leveloffset=+1]

include::../modules/proc-kafka-inline-logging.adoc[leveloffset=+1]

include::../modules/proc-kafka-external-logging.adoc[leveloffset=+1]
