...
An additional `imbalance` mode is available for automatically rebalancing when Cruise Control detects goal violations in the cluster, independent of scaling events.
...
include::../../modules/configuring/proc-automating-rebalances-imbalance.adoc[leveloffset=+1]

include::../../modules/configuring/con-auto-rebalance-imbalance-alerts.adoc[leveloffset=+1]
