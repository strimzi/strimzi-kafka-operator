...
include::../../modules/deploying/proc-manual-stop-pause-connector.adoc[leveloffset=+2]
//Procedure to manually restart a Kafka connector
include::../../modules/deploying/proc-manual-restart-connector.adoc[leveloffset=+2]
//Procedure to manually restart a Kafka connector task
include::../../modules/deploying/proc-manual-restart-connector-task.adoc[leveloffset=+2]
...
include::../../modules/deploying/proc-manual-stop-pause-mirrormaker2-connector.adoc[leveloffset=+2]
