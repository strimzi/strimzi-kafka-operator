...
// `KafkaConnect` resource core configuration (includes minimal configuration)
include::../../modules/configuring/con-config-kafka-connect.adoc[leveloffset=+1]
// Securing Kafka Connect connections (TLS and authentication)
include::../../modules/configuring/con-config-kafka-connect-securing-connections.adoc[leveloffset=+2]
...
// Adding connector plugins (building a custom image)
include::../../modules/configuring/con-config-kafka-connect-build.adoc[leveloffset=+2]
...
// `KafkaBridge` resource core configuration (includes minimal configuration)
include::../../modules/configuring/con-config-http-bridge.adoc[leveloffset=+1]
// Securing connections to Kafka (TLS and authentication)
include::../../modules/configuring/con-config-http-bridge-securing-connections.adoc[leveloffset=+2]
// Granting the HTTP Bridge access to Kafka resources
include::../../modules/configuring/proc-config-http-bridge-user-authorization.adoc[leveloffset=+2]
// Configuring HTTP endpoints (port, CORS, and related HTTP settings)
