...
For more information, see link:{BookURLDeploying}#proc-renewing-ca-certs-manually-{context}[Renewing CA certificates manually^] and link:{BookURLDeploying}#proc-replacing-private-keys-{context}[Replacing private keys^].
