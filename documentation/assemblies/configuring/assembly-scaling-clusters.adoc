...
You use `kafka-reassign-partitions.sh` tool to reassign partitions.
The tool uses a reassignment JSON file to that specifies the topics to reassign.

You can generate a reassignment JSON file or you can create a file manually if you want to move specific partitions.
