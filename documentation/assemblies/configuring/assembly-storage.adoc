...
* Tiered storage (Early access preview)
...
Tiered storage provides more flexibility for data management by leveraging the use of both local storage and remote storage solutions.
Support for tiered storage is being introduced as an early access preview.
