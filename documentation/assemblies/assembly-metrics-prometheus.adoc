...
include::../modules/con-metrics-prometheus-options.adoc[leveloffset=+1]

include::../modules/con-metrics-prometheus-resources.adoc[leveloffset=+1]

include::../modules/proc-metrics-deploying-prometheus-operator.adoc[leveloffset=+1]

include::../modules/proc-metrics-deploying-prometheus.adoc[leveloffset=+1]
