...
:K8sInPlaceResizing: link:https://kubernetes.io/docs/tasks/configure-pod-container/resize-container-resources/[Resize CPU and Memory Resources assigned to Containers^]
