...
:strimzi-project-name: Strimzi Operator
:keycloak-project-name: Keycloak
...
:authz-services-model-ref: xref:con-oauth-authorization-services-model-{context}[Keycloak Authorization Services model for managing permissions]
...
:cli-kafka-image: quay.io/strimzi/kafka:0.21.1-kafka-2.6.0
