...
:DefaultKafkaVersion: 3.2.1
:KafkaVersionLower: 3.1.0
:KafkaVersionHigher: 3.2.1
...
:K8sLocalPersistentVolumes: link:https://kubernetes.io/docs/concepts/storage/volumes/#local[local persistent volume^]
