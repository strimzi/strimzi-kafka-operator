...
:oauth-demo-keycloak: link:https://github.com/strimzi/strimzi-kafka-oauth/tree/main/examples[Using Keycloak as the OAuth 2.0 authorization server^]
:oauth-demo-hydra: link:https://github.com/strimzi/strimzi-kafka-oauth/tree/main/examples/docker#running-with-hydra-using-ssl-and-opaque-tokens[Using Hydra as the OAuth 2.0 authorization server^]
