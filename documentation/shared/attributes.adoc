...
:ProductVersionPrevious: 1.2.0

// Kubernetes versions
:KubernetesVersion: 1.32 and later

// Kafka upgrade attributes used in kafka upgrades section
:DefaultKafkaVersion: 4.3.1
:DefaultKafkaMetadataVersion: 4.3
:KafkaMetadataVersionLower: 4.2-IV1
:KafkaMetadataVersionHigher: 4.3-IV0
:KafkaVersionLower: 4.2.0
:KafkaVersionHigher: 4.3.1
...
:K8sNetworkPolicyPeerAPI: link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#networkpolicypeer-v1-networking-k8s-io[NetworkPolicyPeer API reference^]
