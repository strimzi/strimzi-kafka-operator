...
// Kubernetes in-place resource updates
:K8sInPlaceResizing: link:https://kubernetes.io/docs/tasks/configure-pod-container/resize-container-resources/[resizing CPU and memory resources assigned to containers^]
