...
:DockerKafkaBridge: strimzi/kafka-bridge:{DockerTag}
...
//overview intro text
:intro-text: {ProductName} is a messaging broker that simplifies the process of running Apache Kafka in a Kubernetes cluster, allowing microservices and other applications to share data with extremely high throughput and low latency.
