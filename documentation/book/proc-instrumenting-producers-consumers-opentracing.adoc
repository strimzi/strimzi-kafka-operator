...
Use a Decorator pattern or Interceptors to instrument your producer and consumer code for distributed tracing.

.Procedure

Perform the following steps for each producer and consumer.
