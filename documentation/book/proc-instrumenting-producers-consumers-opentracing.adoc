...
Use a Decorator pattern or Interceptors to instrument your Java producer and consumer code for distributed tracing.

.Procedure

Perform the following steps in the application code of each producer and consumer.
...
----
+
. If you want to use Interceptors, instrument your client code as shown in the following example.
+
[source,java,subs=attributes+]
----
