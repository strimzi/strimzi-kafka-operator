...
The table below lists the fields that you can use when configuring a Kafka cluster deployment. A dot is used to denote a nested YAML object.
...
More info about the topic operator in the related xref:topic-operator-str[Topic Operator] documentation page.
...
More information about these configuration parameters in the related xref:topic-operator-str[Topic Operator] documentation page.
