...
For Mirror Maker, messages are traced from the source cluster to the target cluster; the trace data visualize messages entering and leaving the Mirror Maker component.
