...
/ ...
----
<1> When the Kafka Bridge is deployed, `-bridge` is appended to the name of the Deployment and other related resources. In this example, the Kafka Bridge Deployment is named `quickstart-bridge` and the accompanying Kafka Bridge ervice is named `quickstart-bridge-service`.
+
