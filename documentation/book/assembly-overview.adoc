...
{ProductName} is based on Apache Kafka 2.0.1, a popular platform for streaming data delivery and processing. {ProductName} makes it easy to run Apache Kafka on {ProductPlatformName}.
...
User Operator:: Responsible for managing Kafka users within a Kafka cluster running within {ProductPlatformName} cluster.
