...
You can configure {ProductName} to use JBOD, a data storage configuration of multiple disks, or volume. JBOD is one approach to providing increased data storage for Kafka brokers. It can also improve performance.
