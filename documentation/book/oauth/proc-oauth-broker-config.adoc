...
#...
   authentication:
     type: oauth <1>
     validIssuerUri: <__https://<authorization-server-address>/auth/realms/demo__> <2>
     jwksEndpointUri: <__https://<authorization-server-address>/auth/realms/demo/protocol/openid-connect/certs__> <3>
