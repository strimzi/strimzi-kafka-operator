[id=kafka-connect-configuration-{context}]
...
link:http://kafka.apache.org/11/documentation.html#connectconfigs[Kafka website^]. An example `config` field is provided
below.
