...
For every deployed container, {ProductName} allows you to specify the resources which should be reserved for it and the maximal resources which should be consumed by it.
{ProductName} supports two types of resources:

* Memory
* CPU

{ProductName} ise using the {ProductPlatformName} syntax for specifying CPU and memory resources.
