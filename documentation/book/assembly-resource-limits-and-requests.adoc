...
For every deployed container, {ProductName} allows you to reserve specific resources and define the maximum consumption of those resources.
...
{ProductName} uses the {ProductPlatformName} syntax for specifying CPU and memory resources.
