...
More info about the topic operator in the related xref:deploying-the-topic-operator-using-the-cluster-operator-{context}[Topic Operator] documentation page.
