...
The full schema is described in xref:type-Kafka-reference[].
...
include::assembly-storage.adoc[leveloffset=+2]
include::assembly-configuring-kafka-listeners.adoc[leveloffset=+2]
include::assembly-kafka-authentication-and-authorization.adoc[leveloffset=+2]
