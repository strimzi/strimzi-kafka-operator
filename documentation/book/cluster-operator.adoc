...
Affinities for a Kafka cluster can be configured using:

:: the `kafka-affinity` key in the cluster ConfigMap to set affinity for the Kafka brokers
:: the `zookeeper-affinity` key in the cluster ConfigMap to set affinity for the Zookeeper nodes
