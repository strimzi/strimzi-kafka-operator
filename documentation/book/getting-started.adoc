...
{ProductName} works on all types of Kubernetes cluster irrespective of distribution, from public and private clouds to local deployments intended for development.
...
If you need to use OpenShift-specific features and have no OpenShift cluster `minishift` can be used to create a local cluster.
