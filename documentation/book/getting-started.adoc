...
It can be used on clusters of public and private clouds, local deployments intended for development, and everything in between.
...
{OpenShiftLongName} user needs to have the rights to create and
