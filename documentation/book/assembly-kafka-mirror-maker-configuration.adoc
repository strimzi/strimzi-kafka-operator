...
{ProductName} allows you to customize the configuration of Apache Kafka Mirror Maker by editing most of the options for the related consumer and producer.
Producer options are listed in {ApachaKafkaProducerConfig}.
Consumer options are listed in {ApachaKafkaConsumerConfig}.
