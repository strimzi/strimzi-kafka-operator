...
* Retrieve messages from the Kafka Bridge consumer (you sent these messages to the consumer earlier, in xref:proc-producing-messages-from-bridge-topics-partitions-{context}[Producing messages to topics and partitions]):
+
