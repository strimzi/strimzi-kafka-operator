...
= Configuring Kafka Mirror Maker access control

Configure Kafka Mirror Maker access control using supported authentication mechanisms:

* TLS client authentication
* SASL SCRAM-SHA-512
* SASL PLAIN

For more information on these mechanisms, see xref:assembly-kafka-mirror-maker-authentication-{context}[Authentication].
