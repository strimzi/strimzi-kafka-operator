...
{ProductName} allows you to customise the configuration of Apache Kafka Connect nodes.
You can specify and configure most of the options listed in {ApachaKafkaConnectConfig}.

The only options which cannot be configured are those related to following areas:
