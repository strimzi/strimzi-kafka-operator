...
To use a different namespace than that specified in the repository files, use the following command to download and edit the `prometheus-operator-deployment.yaml` file:
