...
* For more information about deploying a Kafka cluster, see xref:cluster-operator-{context}[]
...
* For more information about creating a topic using the Topic Operator, see xref:creating-a-topic-{context}[]
