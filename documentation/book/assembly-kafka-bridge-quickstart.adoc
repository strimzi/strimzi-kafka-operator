...
* Cluster administrator access to a local or remote Kubernetes cluster (or you are a designated xref:assembly-getting-started-strimzi-admin-str[Strizi Administrator]). 
