...
HTTP requests are formatted as curl commands that you can copy and paste to your terminal. You can use an API testing tool to call the API if preferred. As described in xref:con-requests-kafka-bridge-{context}[Requests to the {ProductName} Kafka Bridge], all POST requests used in this quick start supply the following Content-Type header:
