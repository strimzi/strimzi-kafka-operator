...
The {ProductName} container images for Kafka Connect include the 2 built-in connectors: `FileStreamSourceConnector` and `FileStreamSinkConnector`. You can add your own connectors by using one of the following methods:
