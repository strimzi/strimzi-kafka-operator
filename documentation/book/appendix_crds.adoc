...
|<<type-KafkaPlainListener,`KafkaPlainListener`>>
|tls    1.2+<.<|Configures TLS listener on port 9093.
|<<type-KafkaTlsListener,`KafkaTlsListener`>>
|====

[[type-KafkaPlainListener]]
### `KafkaPlainListener` type v1alpha1 kafka.strimzi.io
...
[[type-KafkaTlsListener]]
### `KafkaTlsListener` type v1alpha1 kafka.strimzi.io
...
Used in: <<type-KafkaTlsListener,`KafkaTlsListener`>>
