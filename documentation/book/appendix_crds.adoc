...
|<<type-KafkaTlsClientAuthentication,`KafkaTlsClientAuthentication`>>
|====

[[type-KafkaTlsClientAuthentication]]
### `KafkaTlsClientAuthentication` type v1alpha1 kafka.strimzi.io

Used in: <<type-TlsListener,`TlsListener`>>


The `type` property is a discriminator that distinguishes the use of the type `KafkaTlsClientAuthentication` from .
It must have the value `tls` for the type `KafkaTlsClientAuthentication`.
[options="header"]
|====
|Field        |Description
