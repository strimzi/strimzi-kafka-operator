...
The topic whitelist, describing which topics have to be mirrored by Kafka Mirror Maker from source to target Kafka cluster, can be configured using the `whitelist` property in `KafkaMirrorMaker.spec`.
