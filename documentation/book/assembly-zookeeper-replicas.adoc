...
Zookeeper clusters / ensembles usually run with odd number of nodes.
It always requires the majority of the nodes to be available in order to maintain quorum.
Maintaining quorum is important because when the Zookeeper cluster loses quorum, it will stop responding to clients.
