...
* A _reassignment JSON file_, `_reassignment.json_`, of how partitions should be reassigned to brokers in the cluster once the broker(s) in the highest numbered `Pod(s)` have been removed.
