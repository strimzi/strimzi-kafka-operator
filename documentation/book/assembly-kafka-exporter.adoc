...
The Kafka Exporter is provided with {ProductName} for deployment with a Kafka cluster to extract additional metrics from Kafka brokers related to offsets, consumer groups, consumer lag, and topics.
The data is used in monitoring for example to help identify slow consumers.
