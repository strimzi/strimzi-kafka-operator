...
The release artifacts contain documentation, example YAML files for deployment on {ProductPlatformName} and a Helm Chart for deployment using https://helm.sh/[Helm^].
