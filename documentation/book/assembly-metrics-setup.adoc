...
.Kafka Exporter
When you have Prometheus and Grafana enabled, you can also use the Kafka Exporter to provide additional monitoring related to consumer lag.
...
include::ref-metrics-config-files.adoc[leveloffset=+1]
...
include::con-metrics-kafka-mini-kube-shift.adoc[leveloffset=+1]
