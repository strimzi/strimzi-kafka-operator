...
An essential aspect of monitoring is to be notified of conditions that indicate a potential issue.
...
include::ref-metrics-prometheus-alerts.adoc[leveloffset=+1]
