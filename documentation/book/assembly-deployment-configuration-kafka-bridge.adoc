...
The full schema of the `KafkaBridge` resource is described in the _<placeholder_link>_.
All labels that are applied to the desired `KafkaBridge` resource will also be applied to the {ProductPlatformName} resources making up the Kafka Bridge cluster.
