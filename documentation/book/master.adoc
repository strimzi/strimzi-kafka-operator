...
Cluster Controller:: Responsible for deploying and managing Apache Kafka clusters within {ProductPlatformName} cluster.
Topic Controller:: Responsible for managing Kafka topics within a Kafka cluster running within {ProductPlatformName} cluster.
