...
----
include::examples/install/cluster-operator/010-ServiceAccount-strimzi-cluster-operator.yaml[]
----
...
----
include::examples/install/cluster-operator/050-Deployment-strimzi-cluster-operator.yaml[lines=1..13]
      # ...
----
...
Cluster Operator is using two different `ClusterRoles`.
The first one includes the permissions needed for namespaced resources.

[source,yaml,options="nowrap"]
.`ClusterRole` with namespaced resources for the Cluster Operator
----
include::examples/install/cluster-operator/020-ClusterRole-strimzi-cluster-operator-role.yaml[]
----

The second includes the permissions needed for cluster-scoped resources.

[source,yaml,options="nowrap"]
.`ClusterRole` with cluster-scoped resoruces for the Cluster Operator
----
include::examples/install/cluster-operator/021-ClusterRole-strimzi-cluster-operator-role.yaml[]
----
...
----
include::examples/install/cluster-operator/030-ClusterRole-strimzi-kafka-broker.yaml[]
----
...
----
include::examples/install/cluster-operator/031-ClusterRole-strimzi-entity-operator.yaml[]
----
...
----
include::examples/install/cluster-operator/021-ClusterRoleBinding-strimzi-cluster-operator.yaml[]
----
...
----
include::examples/install/cluster-operator/030-ClusterRoleBinding-strimzi-cluster-operator-kafka-broker-delegation.yaml[]
----
...
[source,yaml,options="nowrap"]
----
include::examples/install/cluster-operator/020-RoleBinding-strimzi-cluster-operator.yaml[]
----

[source,yaml,options="nowrap"]
----
include::examples/install/cluster-operator/031-RoleBinding-strimzi-cluster-operator-entity-operator-delegation.yaml[]
----