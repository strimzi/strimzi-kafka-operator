...
While removing volumes volumes, you should not change configuration of any other volumes or add new volumes at the same time.
...
For example, remove the volume with ids `1` and `2`:
+
