...
xref:assembly-deployment-configuration-kafka-connect-deployment-configuration-kafka-connect[Kafka Connect cluster configuration]
and
xref:assembly-deployment-configuration-kafka-connect-s2i-deployment-configuration-kafka-connect[Kafka Connect cluster with Source2Image support].
