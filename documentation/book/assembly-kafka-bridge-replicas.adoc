...
IMPORTANT: If a node where Kafka Bridge is deployed to crashes, {ProductPlatformName} will automatically reschedule the Kafka Bridge pod to a different node.
