...
{ProductName} uses the `java-kafka-client` OpenTracing library to simplify the instrumentation of Java client applications. This library is an example of a __tracer__.
