...
`resource`:: The `resource` property specifies the resource the rule applies to.
+
--
...
`host`:: The `host` property specifies a remote host from which is the rule allowed or denied.
+
