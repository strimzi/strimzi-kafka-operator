...
This is beneficial to an {ProductPlatformName}-centric style of deploying applications because it allows you to declare a `KafkaTopic` as part of your application's deployment and the operator will take care of creating the topic for you.
