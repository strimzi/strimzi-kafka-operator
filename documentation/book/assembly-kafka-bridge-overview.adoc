...
Similar to a Kafka Connect cluster, you can deploy the Kafka Bridge into your Kubernetes cluster by using the Cluster Operator. For deployment instructions, see xref:deploying-kafka-bridge-str[].
