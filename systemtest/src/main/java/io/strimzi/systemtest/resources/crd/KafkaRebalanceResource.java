...
public class KafkaRebalanceResource implements ResourceType<KafkaRebalance> {
    ...
    public static void replaceKafkaRebalanceResourceInSpecificNamespace(String namespace, String resourceName, Consumer<KafkaRebalance> editor) {
        ResourceManager.replaceCrdResource(namespace, KafkaRebalance.class, KafkaRebalanceList.class, resourceName, editor);
    }
}
