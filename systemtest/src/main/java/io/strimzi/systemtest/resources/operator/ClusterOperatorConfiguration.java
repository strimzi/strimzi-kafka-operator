...
public class ClusterOperatorConfiguration {
    ...
    private boolean skipNamespaceDeletion = false;
    ...
    public boolean shouldSkipNamespaceDeletion() {
        return skipNamespaceDeletion;
    }

    public void setSkipNamespaceDeletion(boolean skipNamespaceDeletion) {
