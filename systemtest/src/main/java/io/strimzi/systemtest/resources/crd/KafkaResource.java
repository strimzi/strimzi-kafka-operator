            ...
            .editSpec()
                .editKafka()
                    ...
                    .withNewInlineLogging()
                        .addToLoggers("kafka.root.logger.level", Environment.STRIMZI_COMPONENTS_LOG_LEVEL)
                    .endInlineLogging()
                .endKafka()
                .editZookeeper()
                    .withReplicas(zookeeperReplicas)
                    .withNewInlineLogging()
                        .addToLoggers("zookeeper.root.logger", Environment.STRIMZI_COMPONENTS_LOG_LEVEL)
                    .endInlineLogging()
                .endZookeeper()
                .editEntityOperator()
                    .editUserOperator()
                        .withNewInlineLogging()
                            .addToLoggers("rootLogger.level", Environment.STRIMZI_COMPONENTS_LOG_LEVEL)
                        .endInlineLogging()
                    .endUserOperator()
                    .editTopicOperator()
                        .withNewInlineLogging()
