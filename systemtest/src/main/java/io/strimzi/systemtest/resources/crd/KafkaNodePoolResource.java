...
public class KafkaNodePoolResource implements ResourceType<KafkaNodePool> {
    ...
    public static void replaceKafkaNodePoolResourceInSpecificNamespace(String namespace, String resourceName, Consumer<KafkaNodePool> editor) {
        ResourceManager.replaceCrdResource(namespace, KafkaNodePool.class, KafkaNodePoolList.class, resourceName, editor);
    }
