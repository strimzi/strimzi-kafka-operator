...
public class KafkaMirrorMakerResource implements ResourceType<KafkaMirrorMaker> {
    ...
    public static void replaceMirrorMakerResourceInSpecificNamespace(String namespace, String resourceName, Consumer<KafkaMirrorMaker> editor) {
        ResourceManager.replaceCrdResource(namespace, KafkaMirrorMaker.class, KafkaMirrorMakerList.class, resourceName, editor);
    }
