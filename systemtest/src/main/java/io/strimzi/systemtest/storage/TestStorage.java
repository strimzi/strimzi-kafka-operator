...
final public class TestStorage {
    ...
    public TestStorage(ExtensionContext extensionContext, String namespaceName, int messageCount) {
        ...
        this.brokerComponentName = KafkaResourceNames.getBrokerComponentName(clusterName);
        this.controllerComponentName = KafkaResourceNames.getControllerComponentName(clusterName);
        this.mixedComponentName = KafkaResourceNames.getStrimziPodSetName(clusterName, KafkaResourceNames.getMixedPoolName(clusterName));
