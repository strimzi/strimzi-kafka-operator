...
public class VerificationUtils {
    ...
    public static void verifyClusterOperatorKafkaDockerImages(String clusterOperatorNamespaceName, String kafkaNamespaceName, String clusterName, int controllerPods, boolean rackAwareEnabled) {
        ...
        List<String> brokerPods = kubeClient().listPodNames(clusterOperatorNamespaceName, LabelSelectors.kafkaLabelSelector(clusterName, KafkaResourceNames.getBrokerComponentName(clusterName)));
    ...
    public static void verifyClusterOperatorMM2DockerImage(String clusterOperatorNamespace, String mirrorMakerNamespace, String clusterName) {
        ...
        String mirrormaker2Version = KafkaMirrorMaker2Utils.kafkaMirrorMaker2Client().inNamespace(mirrorMakerNamespace).withName(clusterName).get().getSpec().getVersion();
