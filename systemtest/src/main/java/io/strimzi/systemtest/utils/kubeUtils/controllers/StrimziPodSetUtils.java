...
public class StrimziPodSetUtils {
    ...
    public static void annotateStrimziPodSet(String namespaceName, String resourceName, Map<String, String> annotations) {
        ...
        StrimziPodSetResource.replaceStrimziPodSetInSpecificNamespace(namespaceName, resourceName,
            strimziPodSet -> strimziPodSet.getMetadata().setAnnotations(annotations));
    }
