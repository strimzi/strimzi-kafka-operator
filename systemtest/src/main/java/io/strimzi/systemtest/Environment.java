...
public class Environment {
    ...
    // Once we use Kafka 4.0.0 GA release instead of RCs, the ST_FILE_PLUGIN_URL_DEFAULT field should be updated to the original value
    // Tracked by issus https://github.com/strimzi/strimzi-kafka-operator/issues/11200
