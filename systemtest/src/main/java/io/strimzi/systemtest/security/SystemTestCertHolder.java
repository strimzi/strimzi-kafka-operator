...
public class SystemTestCertHolder {
    ...
    public void prepareCustomSecretsFromBundles(final String namespaceName, final String clusterName) {
        ...
        try {
            ...
            SecretUtils.createCustomSecret(namespaceName, this.caCertSecretName, clusterName, this.bundle);
            ...
            Secret secret = SecretUtils.createSecretFromFile(namespaceName, strimziKeyPKCS8.getAbsolutePath(), "ca.key", this.caKeySecretName, additionalSecretLabels);
