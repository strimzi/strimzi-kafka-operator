...
public class KRaftOlmUpgradeST extends AbstractKRaftUpgradeST {
    ...
    void testStrimziUpgrade() throws IOException {
        ...
        String afterUpgradeVersionOfCo = OlmUtils.getCsvWithPrefixInNamespace(CO_NAMESPACE, clusterOperatorConfiguration.getOlmAppBundlePrefix()).getSpec().getVersion();
