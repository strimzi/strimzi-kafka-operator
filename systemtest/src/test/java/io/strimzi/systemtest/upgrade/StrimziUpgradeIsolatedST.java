...
public class StrimziUpgradeIsolatedST extends AbstractUpgradeST {
    ...
    void testUpgradeKafkaWithoutVersion(ExtensionContext extensionContext) throws IOException {
        ...
        UpgradeKafkaVersion upgradeKafkaVersion = UpgradeKafkaVersion.getKafkaWithVersionFromUrl(acrossUpgradeData.getKafkaVersionsUrlFrom(), acrossUpgradeData.getStartingKafkaVersion());
