...
public class OauthScopeST extends OauthAbstractST {
    ...
    private final String audienceListener = "audienlist";
    ...
    void testClientSideScopeKafkaConnect(ExtensionContext extensionContext) throws UnexpectedException {
        ...
        String kafkaConnectPodName = PodUtils.getPodsByPrefixInNameWithDynamicWait(NAMESPACE, clusterName).get(0).getMetadata().getName();
