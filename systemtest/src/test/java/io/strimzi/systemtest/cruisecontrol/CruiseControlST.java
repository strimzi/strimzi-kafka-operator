...
public class CruiseControlST extends AbstractST {
    ...
    void testAutoCreationOfCruiseControlTopicsWithResources() {
        ...
        String ccPodName = PodUtils.listPodsByPrefixInNamespace(testStorage.getNamespaceName(), CruiseControlResources.componentName(testStorage.getClusterName())).get(0).getMetadata().getName();
    ...
    void testCruiseControlChangesFromRebalancingtoProposalReadyWhenSpecUpdated() {
        ...
        KafkaRebalanceUtils.replaceInNamespace(testStorage.getNamespaceName(), testStorage.getClusterName(), kafkaRebalance -> kafkaRebalance.getSpec().setReplicationThrottle(100000));
    ...
    void testCruiseControlReplicaMovementStrategy() {
        ...
        ccPodName = PodUtils.listPodsByPrefixInNamespace(testStorage.getNamespaceName(), CruiseControlResources.componentName(testStorage.getClusterName())).get(0).getMetadata().getName();
