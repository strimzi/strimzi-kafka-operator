...
public class HttpBridgeCorsST extends AbstractST {
    ...
    void beforeAll() {
        ...
        KafkaBridgeHttpCors kafkaBridgeHttpCors = CrdResourceClients.kafkaBridgeClient().inNamespace(suiteTestStorage.getNamespaceName()).withName(suiteTestStorage.getClusterName()).get().getSpec().getHttp().getCors();
