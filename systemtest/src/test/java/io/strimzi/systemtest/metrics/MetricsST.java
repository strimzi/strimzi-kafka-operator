...
public class MetricsST extends AbstractST {
    ...
    void testKafkaMetricsSettingsDeprecatedMetrics() {
        ...
        deprecatedKafkaMetricsData = MetricsUtils.collectKafkaPodsMetrics(kafkaClientsPodName, SECOND_CLUSTER);
    ...
    @Deprecated
    @IsolatedTest("Modification of metricsClusterName shared Kafka cluster and triggering Rolling Update")
    ...
    void testKafkaMM2MetricsSettingsDeprecatedMetrics() {
        ...
        deprecatedKafkaMirrorMaker2MetricsData = MetricsUtils.collectKafkaMirrorMaker2PodsMetrics(kafkaClientsPodName, MIRROR_MAKER_CLUSTER);
    }
