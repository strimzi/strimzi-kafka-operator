...
public class MirrorMakerST extends AbstractST {
    ...
    void testCustomAndUpdatedValues() {
        ...
        assertThat(
                StUtils.checkEnvVarInPod(kubeClient().listPods("type", KafkaMirrorMaker.RESOURCE_KIND).get(0).getMetadata().getName(), usedVariable),
    ...
    void testScaleMirrorMakerSubresource() {
        ...
        String mmGenName = kubeClient().listPods("type", KafkaMirrorMaker.RESOURCE_KIND).get(0).getMetadata().getGenerateName();
        ...
        List<String> mmPods = kubeClient().listPodNames("type", KafkaMirrorMaker.RESOURCE_KIND);
    ...
    void testScaleMirrorMakerToZero() {
        ...
        mmPods = kubeClient().listPodNames("type", KafkaMirrorMaker.RESOURCE_KIND);
