...
public class MirrorMakerST extends AbstractST {
    ...
    void testMirrorMaker(ExtensionContext extensionContext) {
        ...
        LabelVerificator.verifyLabelsOnPods(testStorage.getNamespaceName(), testStorage.getClusterName(), "mirror-maker", KafkaMirrorMaker.RESOURCE_KIND);
        ...
        ResourceAssertions.assertPodResources(testStorage.getNamespaceName(), podName, mmDepName,
                "400M", "2", "300M", "1");
        ResourceAssertions.assertExpectedJavaOpts(testStorage.getNamespaceName(), podName, KafkaMirrorMakerResources.componentName(testStorage.getClusterName()),
    ...
    void testCustomAndUpdatedValues(ExtensionContext extensionContext) {
        ...
        ResourceAssertions.checkReadinessLivenessProbe(testStorage.getNamespaceName(), KafkaMirrorMakerResources.componentName(testStorage.getClusterName()),
        ...
        ResourceAssertions.checkSpecificVariablesInContainer(testStorage.getNamespaceName(), KafkaMirrorMakerResources.componentName(testStorage.getClusterName()),
            KafkaMirrorMakerResources.componentName(testStorage.getClusterName()), envVarGeneral);
        ResourceAssertions.checkComponentConfiguration(testStorage.getNamespaceName(), KafkaMirrorMakerResources.componentName(testStorage.getClusterName()),
