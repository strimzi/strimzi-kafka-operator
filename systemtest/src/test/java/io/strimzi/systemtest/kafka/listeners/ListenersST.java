...
//    ##########################################
    ...
    void testCustomSoloCertificatesForNodePort() {
        ...
        final KafkaProducerConsumer kafkaProducerConsumer = new KafkaProducerConsumerBuilder()
            ...
            .withMessageCount(testStorage.getMessageCount())
            .withAuthentication(ClientsAuthentication.configureTlsCustomCerts(clusterCustomCertServer1, testStorage.getUsername()))
            .build();
    ...
    void testCustomChainCertificatesForNodePort() {
        ...
        final KafkaProducerConsumer kafkaProducerConsumer = new KafkaProducerConsumerBuilder()
            ...
            .withMessageCount(testStorage.getMessageCount())
            .withAuthentication(ClientsAuthentication.configureTlsCustomCerts(clusterCustomCertChain1, testStorage.getUsername()))
            .build();
    ...
    void testCustomCertLoadBalancerAndTlsRollingUpdate() {
        ...
        KafkaProducerConsumer kafkaProducerConsumer = new KafkaProducerConsumerBuilder()
            ...
            .withMessageCount(testStorage.getMessageCount())
            .withAuthentication(ClientsAuthentication.configureTlsCustomCerts(clusterCustomCertServer2, testStorage.getUsername()))
            .build();
