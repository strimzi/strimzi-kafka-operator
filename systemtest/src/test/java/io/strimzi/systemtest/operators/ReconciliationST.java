...
public class ReconciliationST extends AbstractST {
    ...
    void testPauseReconciliationInKafkaAndKafkaConnectWithConnector(ExtensionContext extensionContext) {
        ...
        PodUtils.waitUntilPodStabilityReplicasCount(testStorage.getNamespaceName(), kafkaSsName, 3);
        ...
        RollingUpdateUtils.waitForComponentAndPodsReady(testStorage.getNamespaceName(), kafkaSelector, SCALE_TO);
