...
public class ReconciliationST extends AbstractST {
    ...
    void testPauseReconciliationInKafkaAndKafkaConnectWithConnector() {
        ...
        KafkaNodePoolUtils.replaceKafkaNodePoolInNamespace(testStorage.getNamespaceName(), testStorage.getBrokerPoolName(), knp -> knp.getSpec().setReplicas(SCALE_TO));
        ...
        KafkaUtils.replaceKafkaInNamespace(testStorage.getNamespaceName(), testStorage.getClusterName(), kafka -> kafka.getMetadata().getAnnotations().replace(Annotations.ANNO_STRIMZI_IO_PAUSE_RECONCILIATION, "true", "false"));
        ...
        KafkaConnectorUtils.replaceKafkaConnectorInNamespace(testStorage.getNamespaceName(), testStorage.getClusterName(), connector -> {
    ...
    void testPauseReconciliationInKafkaRebalanceAndTopic() {
        ...
        KafkaTopicUtils.replaceTopicResourceInSpecificNamespace(testStorage.getNamespaceName(), testStorage.getTopicName(), topic -> {
        ...
        KafkaTopicUtils.replaceTopicResourceInSpecificNamespace(testStorage.getNamespaceName(), testStorage.getTopicName(), topic -> topic.getMetadata().getAnnotations().replace(Annotations.ANNO_STRIMZI_IO_PAUSE_RECONCILIATION, "true", "false")
        );
        ...
        KafkaRebalanceUtils.replaceKafkaRebalanceInNamespace(testStorage.getNamespaceName(), testStorage.getClusterName(), rebalance -> rebalance.getMetadata().setAnnotations(PAUSE_ANNO));
        ...
        KafkaRebalanceUtils.replaceKafkaRebalanceInNamespace(testStorage.getNamespaceName(), testStorage.getClusterName(),
