...
| `image.tag`                          | Cluster Operator image tag                | `0.20.0-rc1`                                             |
...
| `kafkaConnect.image.tagPrefix`       | Kafka Connect image tag prefix            | `0.20.0-rc1`                                             |
...
| `kafkaConnects2i.image.tagPrefix`    | Kafka Connect s2i image tag prefix        | `0.20.0-rc1`                                             |
...
| `kafkaMirrorMaker.image.tagPrefix`   | Kafka Mirror Maker image tag prefix       | `0.20.0-rc1`                                             |
...
| `cruiseControl.image.tag`            | Cruise Control image tag prefix           | `0.20.0-rc1`                                             |
...
| `topicOperator.image.tag`            | Topic Operator image tag                  | `0.20.0-rc1`                                             |
...
| `tlsSidecarCruiseControl.image.tag`      | TLS Sidecar for Cruise Control image tag prefix | `0.20.0-rc1`                                            |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag prefix | `0.20.0-rc1`                                       |
