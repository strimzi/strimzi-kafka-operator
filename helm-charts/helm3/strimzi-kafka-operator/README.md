...
| `image.tag`                          | Cluster Operator image tag                | `0.21.1`                                             |
...
| `zookeeper.image.tag`                | ZooKeeper image tag prefix                | `0.21.1`                                             |
...
| `jmxtrans.image.tag`                 | JmxTrans image tag prefix                 | `0.21.1`                                             |
...
| `kafka.image.tagPrefix`              | Kafka image tag prefix                    | `0.21.1`                                             |
...
| `kafkaConnect.image.tagPrefix`       | Kafka Connect image tag prefix            | `0.21.1`                                             |
...
| `kafkaConnects2i.image.tagPrefix`    | Kafka Connect s2i image tag prefix        | `0.21.1`                                             |
...
| `kafkaMirrorMaker.image.tagPrefix`   | Kafka Mirror Maker image tag prefix       | `0.21.1`                                             |
...
| `cruiseControl.image.tag`            | Cruise Control image tag prefix           | `0.21.1`                                             |
...
| `topicOperator.image.tag`            | Topic Operator image tag                  | `0.21.1`                                             |
...
| `userOperator.image.tag`             | User Operator image tag                   | `0.21.1`                                             |
...
| `kafkaInit.image.tag`                | Init Kafka image tag                      | `0.21.1`                                             |
...
| `tlsSidecarCruiseControl.image.tag`      | TLS Sidecar for Cruise Control image tag prefix | `0.21.1`                                   |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag prefix | `0.21.1`                                       |
