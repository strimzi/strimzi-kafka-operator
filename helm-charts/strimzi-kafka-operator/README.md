...
| `image.tag`                          | Cluster Operator image tag                | `0.17.0-rc3`                                             |
...
| `kafkaConnect.image.tagPrefix`       | Kafka Connect image tag prefix            | `0.17.0-rc3`                                             |
...
| `kafkaConnects2i.image.tagPrefix`    | Kafka Connect s2i image tag prefix        | `0.17.0-rc3`                                             |
...
| `kafkaMirrorMaker.image.tagPrefix`   | Kafka Mirror Maker image tag prefix       | `0.17.0-rc3`                                             |
...
| `topicOperator.image.tag`            | Topic Operator image tag                  | `0.17.0-rc3`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag prefix | `0.17.0-rc3`                                            |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag prefix    | `0.17.0-rc3`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag prefix | `0.17.0-rc3`                                       |
