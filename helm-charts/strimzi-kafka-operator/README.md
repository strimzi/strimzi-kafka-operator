...
| `image.tag`                          | Cluster Operator image tag                | `0.9.0`                                             |
...
| `kafkaConnect.image.tag`             | Kafka Connect image tag                   | `0.9.0`                                             |
...
| `kafkaConnects2i.image.tag`          | Kafka Connect s2i image tag               | `0.9.0`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag       | `0.9.0`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag           | `0.9.0`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag  | `0.9.0`                                             |
