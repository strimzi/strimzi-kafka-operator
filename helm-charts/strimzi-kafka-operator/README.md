...
| `image.tag`                          | Cluster Operator image tag                | `0.18.0-rc2`                                             |
...
| `kafkaConnect.image.tagPrefix`       | Kafka Connect image tag prefix            | `0.18.0-rc2`                                             |
...
| `kafkaConnects2i.image.tagPrefix`    | Kafka Connect s2i image tag prefix        | `0.18.0-rc2`                                             |
...
| `kafkaMirrorMaker.image.tagPrefix`   | Kafka Mirror Maker image tag prefix       | `0.18.0-rc2`                                             |
...
| `cruiseControl.image.tag`            | Cruise Control image tag prefix           | `0.18.0-rc2`                                             |
...
| `topicOperator.image.tag`            | Topic Operator image tag                  | `0.18.0-rc2`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag prefix    | `0.18.0-rc2`                                             |
...
| `tlsSidecarCruiseControl.image.tag`      | TLS Sidecar for Cruise Control image tag prefix | `0.18.0-rc2`                                            |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag prefix | `0.18.0-rc2`                                       |
| `kafkaBridge.image.repository`       | Kafka Bridge image repository             | `strimzi`                                            |
| `kafkaBridge.image.name`             | Kafka Bridge image name                   | `kafka-bridge                                        |
| `kafkaBridge.image.tag`              | Kafka Bridge image tag                    | `0.16.0`                                             |
