...
| `image.tag`                          | Cluster Operator image tag                | `0.6.0-rc3`                                             |
...
| `kafkaConnect.image.tag`             | Kafka Connect image tag                   | `0.6.0-rc3`                                             |
...
| `kafkaConnects2i.image.tag`          | Kafka Connect s2i image tag               | `0.6.0-rc3`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag       | `0.6.0-rc3`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag           | `0.6.0-rc3`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag  | `0.6.0-rc3`                                             |
