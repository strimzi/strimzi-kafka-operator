...
| `image.tag`                          | Cluster Operator image tag                | `0.8.2`                                             |
...
| `kafkaConnect.image.tag`             | Kafka Connect image tag                   | `0.8.2`                                             |
...
| `kafkaConnects2i.image.tag`          | Kafka Connect s2i image tag               | `0.8.2`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag       | `0.8.2`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag           | `0.8.2`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag  | `0.8.2`                                             |
