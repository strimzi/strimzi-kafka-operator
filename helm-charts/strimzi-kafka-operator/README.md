...
| `image.tag`                          | Cluster Operator image tag                | `0.11.0-rc2`                                             |
...
| `zookeeper.image.tag`                | ZooKeeper image tag                       | `0.11.0-rc2`                                             |
| `kafka.image.repository`             | Kafka image repository                    | `strimzi`                                            |
| `kafka.image.name`                   | Kafka image name                          | `kafka`                                              |
| `kafka.image.tagPrefix`              | Kafka image tag prefix                    | `0.11.0-rc2`                                             |
...
| `kafkaConnect.image.tagPrefix`       | Kafka Connect image tag prefix            | `0.11.0-rc2`                                             |
...
| `kafkaConnects2i.image.tagPrefix`    | Kafka Connect s2i image tag prefix        | `0.11.0-rc2`                                             |
...
| `kafkaMirrorMaker.image.tagPrefix`   | Kafka Mirror Maker image tag prefix       | `0.11.0-rc2`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag       | `0.11.0-rc2`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag           | `0.11.0-rc2`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag  | `0.11.0-rc2`                                             |
