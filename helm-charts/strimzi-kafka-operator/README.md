...
| `image.tag`                          | Cluster Operator image tag                | `0.11.3`                                             |
...
| `zookeeper.image.tag`                | ZooKeeper image tag                       | `0.11.3`                                             |
| `kafka.image.repository`             | Kafka image repository                    | `strimzi`                                            |
| `kafka.image.name`                   | Kafka image name                          | `kafka`                                              |
| `kafka.image.tagPrefix`              | Kafka image tag prefix                    | `0.11.3`                                             |
...
| `kafkaConnect.image.tagPrefix`       | Kafka Connect image tag prefix            | `0.11.3`                                             |
...
| `kafkaConnects2i.image.tagPrefix`    | Kafka Connect s2i image tag prefix        | `0.11.3`                                             |
...
| `kafkaMirrorMaker.image.tagPrefix`   | Kafka Mirror Maker image tag prefix       | `0.11.3`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag       | `0.11.3`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag           | `0.11.3`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag  | `0.11.3`                                             |
