...
sed -i "s#strimzi/test-client:${DOCKER_TAG}#${DOCKER_ORG}/test-client:${DOCKER_TAG}#g" systemtest/src/main/resources/StrimziUpgradeST.json
...
sed -i "s#strimzi/kafka:latest#${DOCKER_ORG}/kafka:${DOCKER_TAG}#g" systemtest/src/main/resources/StrimziUpgradeST.json
sed -i "s#strimzi/operator:latest#${DOCKER_ORG}/operator:${DOCKER_TAG}#g" systemtest/src/main/resources/StrimziUpgradeST.json
