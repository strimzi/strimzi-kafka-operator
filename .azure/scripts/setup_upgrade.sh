...
sed -i "s#strimzi/test-client:${DOCKER_TAG}#${DOCKER_REGISTRY}/${DOCKER_ORG}/test-client:${DOCKER_TAG}#g" systemtest/src/main/resources/StrimziUpgradeST.json
...
sed -i "s#strimzi/kafka:latest#${DOCKER_REGISTRY}/${DOCKER_ORG}/kafka:${DOCKER_TAG}#g" systemtest/src/main/resources/StrimziUpgradeST.json
sed -i "s#strimzi/operator:latest#${DOCKER_REGISTRY}/${DOCKER_ORG}/operator:${DOCKER_TAG}#g" systemtest/src/main/resources/StrimziUpgradeST.json
