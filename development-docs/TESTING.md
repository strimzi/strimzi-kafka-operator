...
The path is defined by the environmental variable `ENV_FILE`; if the `ENV_FILE` environmental variable is not defined, the default config file location is used `systemtest/config.yaml`.
...
| ENV_FILE                              | Path to file where environment variables are defined in yaml format                                                                                                                                                                                                  | ../systemtest/config.yaml                                         |
