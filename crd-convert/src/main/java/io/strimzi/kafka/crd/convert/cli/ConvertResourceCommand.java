...
public class ConvertResourceCommand extends AbstractConversionCommand {
    @CommandLine.Option(names = {"-k", "--kind"}, arity = "0..10", description = "Resource Kind which should be converted (if not specified, all Strimzi resources will be converted)", required = true)
    String[] kinds;
    ...
    @CommandLine.Option(names = {"--all-namespaces"}, description = "Convert resources in all namespaces", defaultValue = "false")
