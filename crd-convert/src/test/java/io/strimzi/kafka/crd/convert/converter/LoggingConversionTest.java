...
class LoggingConversionTest extends ConversionTestBase<Logging> {

    @Test
    public void testLoggingConversion() throws Exception {
        ...
        conversion(converter, k, ApiVersion.V1BETA2, v -> v.getSpec().getKafka().getLogging());
        conversion(converter, k, ApiVersion.V1BETA2, v -> v.getSpec().getZookeeper().getLogging());
        conversion(converter, k, ApiVersion.V1BETA2, v -> v.getSpec().getEntityOperator().getTopicOperator().getLogging());
        conversion(converter, k, ApiVersion.V1BETA2, v -> v.getSpec().getEntityOperator().getUserOperator().getLogging());
        conversion(converter, k, ApiVersion.V1BETA2, v -> v.getSpec().getCruiseControl().getLogging());
        ...
        KafkaConnect kc = new KafkaConnectBuilder()
            ...
            .endSpec()
            .build();
        conversion(new KafkaConnectConverter(), kc, ApiVersion.V1BETA2, v -> v.getSpec().getLogging());
        ...
        KafkaConnectS2I kcs2i = new KafkaConnectS2IBuilder()
            ...
            .endSpec()
            .build();
        conversion(new KafkaConnectS2IConverter(), kcs2i, ApiVersion.V1BETA2, v -> v.getSpec().getLogging());
        ...
        KafkaMirrorMaker kmm = new KafkaMirrorMakerBuilder()
            ...
            .endSpec()
            .build();
        conversion(new KafkaMirrorMakerConverter(), kmm, ApiVersion.V1BETA2, v -> v.getSpec().getLogging());
        ...
        KafkaMirrorMaker2 kmm2 = new KafkaMirrorMaker2Builder()
            ...
            .endSpec()
            .build();
        conversion(new KafkaMirrorMaker2Converter(), kmm2, ApiVersion.V1BETA2, v -> v.getSpec().getLogging());
        ...
        KafkaBridge kb = new KafkaBridgeBuilder()
            ...
            .endSpec()
            .build();
        conversion(new KafkaBridgeConverter(), kb, ApiVersion.V1BETA2, v -> v.getSpec().getLogging());
    }
