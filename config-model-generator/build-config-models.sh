...
then
    ...
    rm ../topic-operator/src/main/resources/kafka-*-topic-config-model.json || true
    ...
    do
        ...
        "-Dtopic-config-model-file=../topic-operator/src/main/resources/kafka-${version}-topic-config-model.json"
    done
else
