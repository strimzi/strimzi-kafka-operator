...
| `defaultImageTag`                           | Default image tag for all the images except Kafka Bridge                        | `0.45.1`                     |
...
| `kafkaBridge.image.tag`                     | Override default Kafka Bridge image tag                                         | `0.31.2-rc1`                     |
