...
{{- define "strimzi.kafka.image.map" }}
            ...
            - name: STRIMZI_KAFKA_IMAGES
              value: |                 
                ...
                2.6.2={{ default .Values.kafka.image.registry .Values.imageRegistryOverride }}/{{ default .Values.kafka.image.repository .Values.imageRepositoryOverride }}/{{ .Values.kafka.image.name }}:{{ default .Values.kafka.image.tagPrefix .Values.imageTagOverride }}-kafka-2.6.2
            ...
            - name: STRIMZI_KAFKA_CONNECT_IMAGES
              value: |                 
                ...
                2.6.2={{ default .Values.kafkaConnect.image.registry .Values.imageRegistryOverride }}/{{ default .Values.kafkaConnect.image.repository .Values.imageRepositoryOverride }}/{{ .Values.kafkaConnect.image.name }}:{{ default .Values.kafkaConnect.image.tagPrefix .Values.imageTagOverride }}-kafka-2.6.2
            ...
            - name: STRIMZI_KAFKA_CONNECT_S2I_IMAGES
              value: |                 
                ...
                2.6.2={{ default .Values.kafkaConnects2i.image.registry .Values.imageRegistryOverride }}/{{ default .Values.kafkaConnects2i.image.repository .Values.imageRepositoryOverride }}/{{ .Values.kafkaConnects2i.image.name }}:{{ default .Values.kafkaConnects2i.image.tagPrefix .Values.imageTagOverride }}-kafka-2.6.2
            ...
            - name: STRIMZI_KAFKA_MIRROR_MAKER_IMAGES
              value: |                 
                ...
                2.6.2={{ default .Values.kafkaMirrorMaker.image.registry .Values.imageRegistryOverride }}/{{ default .Values.kafkaMirrorMaker.image.repository .Values.imageRepositoryOverride }}/{{ .Values.kafkaMirrorMaker.image.name }}:{{ default .Values.kafkaMirrorMaker.image.tagPrefix .Values.imageTagOverride }}-kafka-2.6.2
            ...
            - name: STRIMZI_KAFKA_MIRROR_MAKER_2_IMAGES
              value: |                 
                ...
                2.6.2={{ default .Values.kafkaMirrorMaker2.image.registry .Values.imageRegistryOverride }}/{{ default .Values.kafkaMirrorMaker2.image.repository .Values.imageRepositoryOverride }}/{{ .Values.kafkaMirrorMaker2.image.name }}:{{ default .Values.kafkaMirrorMaker2.image.tagPrefix .Values.imageTagOverride }}-kafka-2.6.2
