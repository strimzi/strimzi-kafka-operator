...
public class ConfigTest {
    ...
    public void testDefaultConfig() {
        ...
        Properties adminClientProps = session.adminClientProperties(null, null, null);
    ...
    public void testInvalidSaslConfig() {
        ...
        Config config = new Config(map);
        Session session = new Session(kubeClient, config);
        assertThrows(InvalidConfigurationException.class, () -> session.adminClientProperties(null, null, null));
        ...
        assertThrows(IllegalArgumentException.class, () -> sessionWithCredentials.adminClientProperties(null, null, null));
    }
    ...
    public void testScramSaslConfig() {
        ...
        Properties adminClientPropsSHA256 = sessionSHA256.adminClientProperties(null, null, null);
        ...
        Properties adminClientPropsSHA512 = sessionSHA512.adminClientProperties(null, null, null);
        ...
        Properties adminClientPropsPlain = sessionPlain.adminClientProperties(null, null, null);
