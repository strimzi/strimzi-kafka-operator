...
public class DeploymentOperationsMockTest extends ScalableResourceOperationsMockTest<KubernetesClient, Deployment, DeploymentList, DoneableDeployment, ScalableResource<Deployment, DoneableDeployment>> {
