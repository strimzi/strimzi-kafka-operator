...
public class EndpointOperationsMockTest extends ReadyResourceOperationsMockTest<KubernetesClient, Endpoints, EndpointsList, DoneableEndpoints, Resource<Endpoints, DoneableEndpoints>> {
