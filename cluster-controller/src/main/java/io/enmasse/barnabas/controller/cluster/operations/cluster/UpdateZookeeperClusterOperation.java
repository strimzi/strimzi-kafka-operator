...
public class UpdateZookeeperClusterOperation extends ZookeeperClusterOperation {
    ...
    private Future<Void> scaleDown(ZookeeperResource zk, ResourceDiffResult diff) {
    ...
    private Future<Void> patchService(ZookeeperResource zk, ResourceDiffResult diff) {
    ...
    private Future<Void> patchStatefulSet(ZookeeperResource zk, ResourceDiffResult diff) {
        if (diff.getDifferent()) {
    ...
    private Future<Void> scaleUp(ZookeeperResource zk, ResourceDiffResult diff) {
