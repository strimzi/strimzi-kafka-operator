...
public class KafkaUserModelTest {
    ...
    public void testFromCrdTlsUser()   {
        KafkaUserModel model = KafkaUserModel.fromCrd(tlsUser, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testFromCrdTlsExternalUser()   {
        KafkaUserModel model = KafkaUserModel.fromCrd(ResourceUtils.createKafkaUser(new KafkaUserTlsExternalClientAuthentication()), UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testFromCrdQuotaUser()   {
        KafkaUserModel model = KafkaUserModel.fromCrd(quotasUser, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testFromCrdQuotaUserWithNullValues()   {
        ...
        KafkaUserModel model = KafkaUserModel.fromCrd(quotasUserWithNulls, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testGenerateSecretWithPrefix()    {
        ...
        KafkaUserModel model = KafkaUserModel.fromCrd(tlsUser, secretPrefix, Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, mockCertManager, passwordGenerator, clientsCaCert, clientsCaKey, null, 365, 30, null, Clock.systemUTC());
        Secret generatedSecret = model.generateSecret();
    ...
    public void testGenerateSecretWithMetadataOverrides()    {
        ...
        KafkaUserModel model = KafkaUserModel.fromCrd(userWithTemplate, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, mockCertManager, passwordGenerator, clientsCaCert, clientsCaKey, null, 365, 30, null, Clock.systemUTC());
        Secret generatedSecret = model.generateSecret();
    ...
    public void testGenerateSecretGeneratesKeyStoreWhenOldVersionSecretExists() {
        ...
        model = KafkaUserModel.fromCrd(tlsUser, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testGenerateSecretGeneratesPasswordWhenNoUserSecretExists()    {
        KafkaUserModel model = KafkaUserModel.fromCrd(scramShaUser, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testGenerateSecretUseDesiredPasswordWhenSpecified()    {
        ...
        KafkaUserModel model = KafkaUserModel.fromCrd(user, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    ...
    public void testFromCrdTlsUserWith65CharTlsUsernameThrows()    {
        ...
        assertThrows(InvalidResourceException.class, () -> {
            ...
            KafkaUserModel.fromCrd(tooLong, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
        });
    }
    ...
    public void testFromCrdTlsUserWith64CharTlsUsernameValid()    {
        ...
        KafkaUserModel.fromCrd(notTooLong, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
    }
    ...
    public void testFromCrdScramShaUserWithEmptyPasswordThrows()    {
        ...
        InvalidResourceException e = assertThrows(InvalidResourceException.class, () -> {
            KafkaUserModel.fromCrd(emptyPassword, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
        });
    ...
    public void testFromCrdScramShaUserWithMissingPasswordKeyThrows()    {
        ...
        InvalidResourceException e = assertThrows(InvalidResourceException.class, () -> {
            KafkaUserModel.fromCrd(missingKey, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.getDefaultValue()), false);
        });
    ...
    public void testFromCrdAclsWithAclsAdminApiSupportMissing()    {
        InvalidResourceException e = assertThrows(InvalidResourceException.class, () -> KafkaUserModel.fromCrd(scramShaUser, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), false, false));
    ...
    public void testFromCrdScramSha512NotSupportedInKraft()    {
        InvalidResourceException e = assertThrows(InvalidResourceException.class, () -> KafkaUserModel.fromCrd(scramShaUser, UserOperatorConfig.SECRET_PREFIX.getDefaultValue(), true, true));
