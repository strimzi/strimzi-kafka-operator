...
public class KafkaUserModelTest {
    ...
    private final UserCertIssuer caProvider = new InternalCaUserCertIssuer(new MockCertIssuer(), passwordGenerator, null, Clock.systemUTC());
    ...
    public void testGenerateSecret() {
        KafkaUserModel model = KafkaUserModel.fromCrd(tlsUser, UserOperatorConfig.SECRET_PREFIX.defaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.defaultValue()));
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCert, clientsCaKey, null, 365, 30, true);
    ...
    public void testGenerateSecretWithoutPkcs12() {
        KafkaUserModel model = KafkaUserModel.fromCrd(tlsUser, UserOperatorConfig.SECRET_PREFIX.defaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.defaultValue()));
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCert, clientsCaKey, null, 365, 30, false);
    ...
    public void testMissingOrWrongCaSecrets() {
        ...
        InvalidCertificateException e = assertThrows(InvalidCertificateException.class, () -> {
            model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, null, clientsCaKey, null, 365, 30, true);
        });
        assertThat(e.getMessage(), is("The Clients CA Cert Secret is missing"));

        e = assertThrows(InvalidCertificateException.class, () -> {
            model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCert, null, null, 365, 30, true);
        });
        assertThat(e.getMessage(), is("The Clients CA Key Secret is missing"));

        e = assertThrows(InvalidCertificateException.class, () -> {
            model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, emptySecret, clientsCaKey, null, 365, 30, true);
        });
        assertThat(e.getMessage(), is("The Clients CA Cert Secret is missing the ca.crt file"));

        e = assertThrows(InvalidCertificateException.class, () -> {
            model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCert, emptySecret, null, 365, 30, true);
        });
    ...
    public void testGenerateSecretGeneratesCertificateAtCaChange() {
        ...
        KafkaUserModel model = KafkaUserModel.fromCrd(tlsUser, UserOperatorConfig.SECRET_PREFIX.defaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.defaultValue()));
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCertSecret, clientsCaKeySecret, userCert, 365, 30, true);
        Secret generatedSecret = model.generateSecret(true);
    ...
    public void testGenerateSecretWithUserSpecificValidityPolicy() throws CertificateException {
        ...
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, new InternalCaUserCertIssuer(new OpenSslCertIssuer(Clock.systemUTC()), passwordGenerator, null, Clock.systemUTC()), clientsCaCert, clientsCaKey, null, 365, 30, true);
    ...
    public void testGenerateSecretGeneratedCertificateDoesNotChangeFromUserProvided() {
        ...
        KafkaUserModel model = KafkaUserModel.fromCrd(tlsUser, UserOperatorConfig.SECRET_PREFIX.defaultValue(), Boolean.parseBoolean(UserOperatorConfig.ACLS_ADMIN_API_SUPPORTED.defaultValue()));
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCert, clientsCaKey, userCert, 365, 30, true);
        Secret generatedSecret = model.generateSecret(true);
    ...
    public void testGenerateSecretGeneratesKeyStoreWhenOldVersionSecretExists() {
        ...
        model.maybeGenerateCertificates(Reconciliation.DUMMY_RECONCILIATION, caProvider, clientsCaCert, clientsCaKey, oldSecret, 365, 30, true);
        Secret generatedSecret = model.generateSecret(true);
