...
@Crd(
    spec = @Crd.Spec(
        ...
        versions = {
            ...
            @Crd.Spec.Version(name = Constants.V1BETA2, served = true, storage = true, deprecated = true, deprecationWarning = "Version v1beta2 of the KafkaTopic API is deprecated. Please use the v1 version instead."),
