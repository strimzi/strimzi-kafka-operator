...
@JsonPropertyOrder({ "conditions", "observedGeneration", "userTaskId", "optimizationResult" })
@EqualsAndHashCode
...
public class KafkaClusterRebalanceStatus extends Status {
    ...
    @Description("The identification number of the last request sent to Cruise Control")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
