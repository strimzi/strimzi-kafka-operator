...
@EqualsAndHashCode
public class KafkaConnect extends AbstractCustomResource<KafkaConnectSpec, KafkaConnectStatus> implements UnknownPropertyPreserving, HasStatus<KafkaConnectStatus> {
