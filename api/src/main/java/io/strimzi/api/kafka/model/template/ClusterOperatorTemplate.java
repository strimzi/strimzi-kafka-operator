...
public class ClusterOperatorTemplate implements Serializable {

    private static final long serialVersionUID = 1L;

    private MetadataTemplate metadata;
    private ClusterOperatorSpecTemplate spec;
    ...
    public ClusterOperatorSpecTemplate getSpec() {
        return spec;
    }

    public void setSpec(ClusterOperatorSpecTemplate spec) {
        this.spec = spec;
    }
