...
Full instructions for the example are available in the [Strimzi Documentation](https://strimzi.io/docs/operators/0.31.1/configuring.html#proc-oauth-authorization-keycloak-example_str).
