                    ...
                    .withNewSpec()
                        .withNewZookeeper()
                            ...
                            .withNewJmxPrometheusExporterMetricsConfig()
                                .withNewValueFrom()
                                    .withConfigMapKeyRef(new ConfigMapKeySelectorBuilder().withName("zoo-metrics").withKey("metrics-cm").withOptional(false).build())
                                .endValueFrom()
                        ...
                        .withNewKafka()
                            ...
                            .withNewJmxPrometheusExporterMetricsConfig()
                                .withNewValueFrom()
                                    .withConfigMapKeyRef(new ConfigMapKeySelectorBuilder().withName("kafka-metrics").withKey("metrics-cm").withOptional(false).build())
                                .endValueFrom()
                            .endJmxPrometheusExporterMetricsConfig()
                        .endKafka()
